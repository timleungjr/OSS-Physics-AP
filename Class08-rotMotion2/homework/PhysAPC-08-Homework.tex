...
\begin{questions}
  ...
  \begin{parts}
    \part On the diagrams below that represent the sphere and the body, draw
    and label all the forces that act on the objects. Forces should be drawn
    as arrows originating at, and pointing away from, the objects.
    \begin{center}
      \vspace{.4in}
      \begin{tikzpicture}[scale=.7]
        \shade[ball color=lightgray] circle (2);% node[below right]{$m$};
    ...
    \part Find the magnitude of acceleration ($a$) of the body.
    \vspace{\stretch1}
    
    \part Find the magnitude of the tension force ($F_T$) in the string.
    \vspace{\stretch1}
  \end{parts}
  \newpage
  ...
  and the cylinder falls vertically as shown in the figure below.
  \begin{center}
  ...
  \end{center}
  \begin{parts}
    \part On the diagram that represent the cylinder, draw and label all
    forces acting on it. Forces should be draw at the point where they are
    applied, and should be represented as arrows originating at, and pointing
    ...
    \begin{center}
      ...
      \vspace{.7in}
    \end{center}
    \part Find the magnitude of acceleration of the body, and
    \vspace{\stretch1}
    
    \part Find the magnitude of the tension force in the string.
    \vspace{\stretch1}
  \end{parts}
  \newpage
