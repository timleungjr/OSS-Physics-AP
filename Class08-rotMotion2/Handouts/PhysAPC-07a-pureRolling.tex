...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}[scale=1.3]
    ...
    \draw[thick](-2,-1)--(2,-1);
    \draw[thick,->](1.5,0)--(2.5,0) node[right]{$\bm{v}$};
    ...
    \begin{scope}[->,ultra thick]
      \draw[blue!80!black](0,0)--(0,-1.5) node[below]{$m\bm{g}$};
      \draw[red!80!black](-.03,-1)--(-.03,.5) node[above]{$\bm{N}$};
    \end{scope}
  \end{tikzpicture}
...
$\bm{f}_s$ acting up the ramp at at the point of contact between the sphere and
the surface.
\begin{figure}[!ht]
  \centering
  \begin{tikzpicture}[scale=1.3]
    \begin{scope}[rotate=-30]
      ...
      \fill(0,0) circle(.05) node[right]{\small CM};
      \begin{scope}[->,ultra thick]
        \draw[blue!80!black,rotate=30](0,0)--(0,-1.5) node[below]{$m\bm{g}$};
        \draw[red!80!black](.0,-1)--(.0,.3) node[above]{$\bm{N}$};
        \draw[green!80!black](.0,-1)--(-.5,-1) node[left]{$\bm{f}_s$};
      \end{scope}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}[scale=1.3]
    ...
    \shade[balloon](0,0) circle(1);
    \draw[thick](-2,-1)--(2,-1);
    \draw[thick,->](0,1.2) arc(90:60:1.2) node[below right]{$\bm{\omega}$};
    \draw[->](2,0)--(3,0) node[right]{$x$};
    \draw[->](2,0)--(2,1) node[above]{$y$};
    \fill(0,0) circle(.05) node[right]{\small CM};
    \begin{scope}[->,ultra thick]
      \draw[blue!80!black](0,0)--(0,-1.5) node[below]{$m\bm{g}$};
      \draw[red!80!black](-.05,-1)--(-.05,.5) node[above]{$\bm{N}$};
      \draw[green!80!black](0,-1)--(.75,-1) node[below]{$\bm{f}_k$};
    \end{scope}
  \end{tikzpicture}
