...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}[scale=1.3]
    ...
    \begin{scope}[->,ultra thick]
      \draw[blue!80!black](0,0)--(0,-1.5) node[below]{$m\vec g$};
      \draw[red!80!black](-.03,-1)--(-.03,.5) node[above]{$\vec N$};
    \end{scope}
  \end{tikzpicture}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}[scale=1.3]
    \begin{scope}[rotate=-30]
      ...
      \draw[thick,->](0,1.2) arc(90:60:1.2) node[pos=.3,right]{$\vec\omega$};
      \draw[->](2,0)--(3,0) node[right]{$x$};
      \draw[->](2,0)--(2,1) node[above]{$y$};
      \fill circle(.05) node[right]{\small cm};
      \begin{scope}[->,ultra thick]
        \draw[blue!80!black,rotate=30](0,0)--(0,-1.5) node[below]{$m\vec g$};
        \draw[red!80!black](.0,-1)--(.0,.3) node[above]{$\vec N$};
        \draw[green!80!black](.0,-1)--(-.5,-1) node[left]{$\vec f_s$};
      \end{scope}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}[scale=1.3]
    \shade[ball color=gray!20] circle(1);
    \draw[thick](-2,-1)--(2,-1);
    \draw[thick,->](0,1.2) arc(90:60:1.2) node[below right]{$\vec\omega$};
    \draw[->](2,0)--(3,0) node[right]{$x$};
    \draw[->](2,0)--(2,1) node[above]{$y$};
    \fill circle(.05) node[right]{\small cm};
    \begin{scope}[->,ultra thick]
      \draw[blue!80!black](0,0)--(0,-1.5) node[below]{$m\vec g$};
      \draw[red!80!black](-.05,-1)--(-.05,.5) node[above]{$\vec N$};
      \draw[green!80!black](0,-1)--(.75,-1) node[below]{$\vec f_k$};
    \end{scope}
  \end{tikzpicture}
