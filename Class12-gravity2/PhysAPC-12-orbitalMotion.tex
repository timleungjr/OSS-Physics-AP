...
\begin{frame}{Relating Gravitational and Centripetal Force}
  Assuming a small mass $m$ in \emph{circular} orbit around a much larger mass
  $M$. The required centripetal force is supplied by the gravitational force:
  ...
  of the orbital velocity is tangent to the circular path.
\end{frame}
