...
\gentitle{12}{UNIVERSAL GRAVITATION, PART 2}
...
\genfreetitle{12}{UNIVERSAL GRAVITATION, PART 2}{2}
\genfreedirections
  ...
  \begin{parts}
    ...
    \begin{center}
      \begin{tikzpicture}[xscale=.48,yscale=.35]
        ...
        \draw[dashed,gray,thick] grid(30,30);
        \draw[very thick,step=5] grid(30,30);
      \end{tikzpicture}
    \end{center}
