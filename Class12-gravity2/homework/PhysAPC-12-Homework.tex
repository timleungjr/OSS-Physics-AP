...
\gentitle{11 \& 12}{UNIVERSAL GRAVITATION}
    ...
    \uplevel{
      ...
      \begin{center}
        \begin{tikzpicture}[scale=.7]
          \shade[ball color=gray] circle(.25) node[below]{$M$};
          \draw[dashed] circle(3);
          \begin{scope}[rotate=50]
            \draw[->](0.25,0)--(2.8,0) node[midway,right]{$R$};
            \shade[ball color=gray] (3,0) circle (0.2) node[right]{$m$};
            \draw[thick,->](3,0.25)--(3,1.25) node[above]{$\varv$};
          \end{scope}
          \begin{scope}[rotate=130]
            \shade[ball color=gray] (3,0) circle (0.2) node[left]{$2m$};
            \draw[thick,->](3,-0.25)--(3,-1.25) node[above]{$\varv$};
          \end{scope}
        \end{tikzpicture}
      \end{center}
