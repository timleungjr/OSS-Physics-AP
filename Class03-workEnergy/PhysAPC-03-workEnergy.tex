...
\begin{frame}{Mechanical Work}
  ...
  \eq{-.1in}{
    \boxed{
      W=\int_\mathcal{C}\vec F(\vec x)\cdot\dl\vec x
    }
  }
...
\begin{frame}{Work-Energy Theorem}
  ...
  \begin{itemize}
  %\item $\Delta K$ can be positive or negative depending on whether work done
...
\begin{frame}{Gravitational Force \& Gravitational Potential Energy}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.6]
      ...
      \draw[vectors,red] (0,4)--(0,2) node[below=-1]{$m\vec g$};
    \end{tikzpicture}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Gravitational Potential Energy}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.55,thick]
      ...
      \draw[vectors,violet] (0,6)--(0,3) node[midway,right]{$\Delta x$};
...
\begin{frame}{Work by Friction, an Illustration}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[scale=.9,vectors]
      ...
      \draw (0,0)--(0, 1) node[above,fill=pink!50]{$\vec N_{12}$};
      \draw (0,0)--(1.5,0) node[right,fill=yellow!50]{$\vec f_{12}$};
    \end{tikzpicture}
    \hspace{.2in}
    \begin{tikzpicture}[vectors]
      \fill circle (.08);
      \draw (0,0)--(0,-1) node[below left]{$m_1\vec g$};
      \draw (.05,0)--(.05,-1)
      node[below right,fill=pink!50]{$\vec N_{12}$};
...
\begin{frame}{Law of Conservation of Energy}
  ...
  \eq{-.1in}{
    \boxed{
      E_\text{sys} = \underbrace{K + \sum U_i}_\text{mechanical} +
  ...
  \eq{-.2in}{
    \boxed{
      \Delta E_\text{sys}=\Delta K + \sum\Delta U + \sum\Delta E_\text{int}
      %= W_\text{ext}
    }
  }
\end{frame}
...
\begin{frame}{Law of Conservation of Energy}
  ...
  \eq{-.1in}{
    \boxed{
      \Delta K + \sum\Delta U + \sum\Delta E_\text{int}= 0
    }
  }
\end{frame}
...
\begin{frame}{Example: Horizontal Spring-Mass System}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.15]
      ...
      \draw[vectors,red] (5.5,1)--(5.5,0) node[below]{$m\vec g$};
...
\begin{frame}{Example: Vertical Spring-Mass System}
  \begin{columns}
    ...
    \begin{tikzpicture}
      ...
      \draw[vectors,red] (1,2)--(1,1)node[right]{$m\vec g$};
...
\begin{frame}{Isolated System with Changing Internal Energy}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.66]
      ...
      \draw[thick,
        decoration={aspect=.3,segment length=2mm, amplitude=2.5mm, coil},
        decorate] (2.5,3.8)--(2.5,2.25) node[midway,right=3.5]{$k$};
      \draw[mass] (2,2.25) rectangle (3,1.25) node[midway]{$m$};
    \end{tikzpicture}
  \end{center}
...
\begin{frame}{Isolated System vs.\ Open System}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.6]
      ...
      \draw[thick,
        decoration={aspect=.3,segment length=2mm, amplitude=2.5mm, coil},
        decorate] (2.5,4)--(2.5,2.25) node[midway,right=3.5]{$k$};
      \draw[mass] (2,2.25) rectangle (3,1.25) node[midway]{$m$};
    \end{tikzpicture}
  \end{center}
  The solution:
...
\begin{frame}{Power}
  ...
  \eq{-.1in}{
    P=\diff Wt=\frac{F\cdot\dl\vec x}{\dl t}
