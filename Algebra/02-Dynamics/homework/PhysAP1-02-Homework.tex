...
%    \end{enumerate}
  ...
  slowing down with an acceleration of \SI{-6}{\metre\per\second^2}. The mass
  has a weight $\mb{w}$, and encounters a frictional force $\mb{f}$ and a
