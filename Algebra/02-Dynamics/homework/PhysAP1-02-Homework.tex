...
%    \pic{.2}{law-of-inertia.png}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.9]
      ...
      \draw[thick](-1.4,-1.5)rectangle(-.6,-2.4)node[midway]{\small\SI{2}{kg}};
      \draw[thick](1,0)--(1,-2.5);
      \draw[thick](.65,-2.5)rectangle(1.35,-3.1)node[midway]{\small\SI{1}{kg}};
      \draw[thick,->](-2,-2.4)--(-2,-4) node[midway,left]{$D$};
      \draw[thick](-1.5,-2.4)--(-2.2,-2.4);
      \draw[thick](-1.8,-4)--(-2.2,-4);
    \end{tikzpicture}
  \end{center}
