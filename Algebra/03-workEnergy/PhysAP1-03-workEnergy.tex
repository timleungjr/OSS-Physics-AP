...
\begin{frame}{Gravitational Force \& Gravitational Potential Energy}
  ...
  \vspace{-.1in}Near Earth's surface, $\mb{g}=-g\kkk=-9.81\kkk$
  \si{\metre\per\second^2} can be considered to be constant. Using the
  definition of mechanical work, the work done to move an object from height
  $h_0$ to $h_1$ is therefore:
