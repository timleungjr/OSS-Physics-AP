...
\begin{frame}{Mechanical Work}
  ...
  object by $\Delta \mb{x}$. If the force is constant, then the work done is
  given by the dot product between the force and displacement vectors:
...
\begin{frame}{Gravitational Force \& Gravitational Potential Energy}
  ...
  $\mb{g}=-g\bm{\hat{\jmath}}=-9.81\bm{\hat{\jmath}}$ \si{\metre\per\second^2}
