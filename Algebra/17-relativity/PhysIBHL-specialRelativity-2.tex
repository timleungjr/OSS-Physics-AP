...
\begin{frame}{Example Problem}
  ...
  \uncover<3>{
    ...
    \item Jim observes that in the time it took Kim's clock to run
      \SI{10.}\second, his watch has already gone \SI{16.7}\second, therefore
...
\begin{frame}{Example Problem}
  ...
  \uncover<2>{
    ...
    \item Kim observes that in the time it took Jim's clock to run
      \SI{10.}\second, her watch has already gone \SI{16.7}\second, therefore
...
\begin{frame}{Relative Velocity}
  ...
  \eq{-.2in}{
    \boxed{
      \bm{v}_{AC}=
      \dfrac{\bm{v}_{AB}+\bm{v}_{BC}}
           {1+\dfrac{\bm{v}_{AB}\cdot\bm{v}_{BC}}{c^2}}
    }
  }
