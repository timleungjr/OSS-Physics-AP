...
\begin{frame}{Second Law of Motion for Rotational Motion}
  ...
  \eq{-.2in}{
    \bar{\mb{F}}=\frac{\Delta\mb{p}}{\Delta t}\quad\quad
    \bar{\bm{\tau}}=\frac{\Delta\mb{L}}{\Delta t}
  }

  For objects with constant mass (for translational motion) or constant moment
  of inertia (for rotational motion), the second law reduces to:
