...
\begin{frame}{Momentum}
  ...
  mass $m$ and velocity $\mb{v}$. The unit of momentum is
...
\begin{frame}{General Form of Second Law of Motion}
  ...
  \eq{-.15in}{
    ...
    =m\frac{\Delta\mb{v}}{\Delta t}=\boxed{m\mb{a}=\mb{F}_\mathrm{net}}
  }
  ...
  \eq{-.2in}{
    \boxed{\mb{F}_{\textrm{net}}=\frac{\Delta\mb{p}}{\Delta t}}
  }
\end{frame}
...
\begin{frame}{Impulse}
  Any force $\overline{\mb{F}}$ acting on an object over a time $\Delta t$
  generates an impulse, regardless of whether or not there is a change in
  momentum:
  ...
  The force is an \textbf{time-averaged force} $\overline{\mb{F}}$ is the
