...
\genfreetitle{2}{MODERN PHYSICS}{5}
...
\begin{center}
  \begin{tikzpicture}[yscale=.5,xscale=.8]
    ...
    \draw(0,-1)--(3,-1) node[pos=0,left]{$n=3$} node[pos=1,right]{-6.04 eV};
    \draw(0,-2)--(3,-2) node[pos=0,left]{$n=2$} node[pos=1,right]{-13.6 eV};
    \draw(0,-4)--(3,-4) node[pos=0,left]{$n=2$} node[pos=1,right]{-54.4 eV};
  \end{tikzpicture}\\
