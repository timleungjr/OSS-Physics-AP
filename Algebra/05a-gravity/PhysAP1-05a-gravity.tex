...
\begin{frame}{Law of Universal Gravitation}
  \begin{center}
    \begin{tikzpicture}[scale=.65]
      \draw[->,very thick,red] (0,0)--(2,0) node[right]{$\mb{F}_g$};
      \draw[->,very thick,blue](8,0)--(6,0) node[left] {$\mb{F}_g$};
...
\begin{frame}{Gravitational Field}
  We generally describe the gravitational force $\mb{F}_g$ (or weight $\mb{w}$)
  as:
...
%
%    \column{.7\textwidth}
%    It can be shown mathematically that the gravitational field \emph{inside} a
