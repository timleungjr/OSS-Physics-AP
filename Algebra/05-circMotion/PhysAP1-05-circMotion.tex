...
\begin{frame}{Banked Curves on Highways and Racetracks}
  \begin{columns}
    ...
    \begin{tikzpicture}
      \fill(0,0) circle(.07);
      \begin{scope}[very thick,->]
        \draw[rotate=-30](0,0)--(0, 1)node[above]{$\mb{N}$};
        \draw            (0,0)--(0,-1)node[below]{$m\mb{g}$};
        \draw[rotate=60] (0,0)--(0,-1)node[right]{$\mb{f}$};
      \end{scope}
    \end{tikzpicture}
    \begin{tikzpicture}
    ...
    \begin{tikzpicture}[scale=.8]
      ...
      \begin{scope}[rotate=20]
        ...
        \begin{scope}[very thick,red!70!black,->]
          \draw(0,-5)--(0,-3.3) node[left]{\footnotesize $\mb{T}$};
    ...
    \begin{tikzpicture}[scale=.75]
      ...
      \begin{scope}[rotate=45]
        ...
        \begin{scope}[very thick,->,red!70!black]
          ...
          \end{scope}
          \draw(0,-5)--(0,-3.9) node[left]{\footnotesize $\mb{T}$};
...
\begin{frame}{Simple Pendulum}
  ...
  \vspace{.1in}\begin{columns}
    ...
    \begin{tikzpicture}[scale=.8]
      ...
      \shade[balloon] (0,-5) circle (.2);
      \begin{scope}[very thick,red!70!black,->]
        \draw(0,-5)--(0,-2.5) node[right]{\footnotesize $\mb{T}$};
        \draw(0,-5)--(0,-6.5) node[below]{\footnotesize $m\mb{g}$};
      \end{scope}
      \draw[dashed,thin](3.54,-3.54) arc(315:225:5);
    \end{tikzpicture}
