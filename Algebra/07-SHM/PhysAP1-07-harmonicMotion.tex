  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.1]
      ...
      \begin{scope}[very thick,->,red!80!black]
        \draw (5.5,1)--(5.5,0) node[below]{\footnotesize $m\mb{g}$};
        \draw (5.5,1)--(5.5,2) node[above]{\footnotesize $\mb{N}$};
        \draw (5.5,1)--(4.5,1) node[above]{\footnotesize $\mb{F}_s$};
      \end{scope}
    \end{tikzpicture}
  \end{center}
...
\begin{frame}{Vertical Spring-Mass System}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=1.3]
      ...
      \begin{scope}[very thick,->,red!80!black]
        \draw(1,2)--(1,1)node[right]{\footnotesize $m\mb{g}$};
        \draw(1,1)--(1,3)node[right]{\footnotesize $\mb{F}_s$};
      \end{scope}
...
\begin{frame}{Vertical Spring-Mass System}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=1.3]
      ...
      \draw[->](1.75,3)--(1.75,2) node[below]{$x$};
      \begin{scope}[very thick,->,red!80!black]
        \draw(1,2)--(1,1) node[right]{\footnotesize $\mb{w}$};
        \draw(1,1)--(1,3) node[right]{\footnotesize $\mb{F}_s$};
      \end{scope}
      \fill[red](1,2) circle(.05);
    \end{tikzpicture}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}
      ...
      \begin{scope}[rotate=10]
        ...
        \begin{scope}[very thick,->,red!80!black]
          \draw[dotted](0,-5)--(-0.5,-5)node[left]{\footnotesize $mg\sin\beta$};
          \draw (0,-5)--(0,-3) node[left]{\footnotesize $\mb{T}$};
          \draw[rotate around={-10:(0,-5)}](0,-5)--(0,-6.5)
          node[below]{\footnotesize $m\mb{g}$};
        \end{scope}
      \end{scope}
...
\begin{frame}{The Simple Pendulum}
  \begin{columns}
    ...
    shows that for small angles ($\beta<\ang{10}$), $\sin\beta\approx\beta$
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \uncover<2->{
        ...
        \begin{scope}[very thick,->,red!80!black]
          \draw(3.5,1)--(3.5,0) node[below]{$m\mb{g}$};
          \draw(3.5,1)--(3.5,2) node[above]{$\mb{N}$};
          \draw(3.5,1)--(2.5,1) node[above]{$\mb{F}_s$};
          \draw(3.5,1)--(4.5,1) node[below]{$\mb{F}_D$};
        \end{scope}
      }
    \end{tikzpicture}
  \end{center}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \begin{scope}[very thick,->,red!80!black]
        ...
        \draw (3.5,1)--(3.5,2) node[above]{$\mb{N}$};
        \draw (3.5,1)--(2.5,1) node[above]{$\mb{F}_s$};
        \draw (3.5,.9)--(2,.9) node[below]{$\mb{F}_\text{ext}$};
        \draw (3.5,1)--(4.5,1) node[below]{$\mb{F}_D$};
      \end{scope}
    \end{tikzpicture}
  \end{center}
