...
\begin{frame}{Vertical Spring-Mass System}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=1.3]
      ...
      node[pos=1,right]{\footnotesize $m\mb{g}$};
    ...
    \column{.8\textwidth}
    For a vertical spring-mass system, we must consider the weight $m\mb{g}$
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \uncover<2->{
        ...
        \draw[ultra thick,->,red](3.5,1)--(3.5,0) node[pos=1,below]{$m\mb{g}$};
...
\begin{frame}{Forced Harmonic Motion}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      node[pos=1,below]{$\mb{F}_\text{ext}$};
      \draw[ultra thick,->,red](3.5,1)--(4.5,1) node[pos=1,below]{$\mb{F}_D$};
    \end{tikzpicture}
  \end{center}
