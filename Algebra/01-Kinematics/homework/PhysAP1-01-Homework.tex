...
\item The vertical position of an elevator as a function of time is shown above.
  ...
  \item 
    ...
    \end{enumerate}
    \newpage
  \item Suppose that there is a passenger of mass 70 kg in the elevator.
    Calculate the apparent weight of the passenger at time $t=\SI{4}{s}.
  \end{enumerate}
  \vspace{1in}
