...
%    \item Objects traveling in the direction of ether contracts in length,
...
\begin{frame}{Relativistic Momentum}
  \emph{The definition of momentum has not changed}, but in relativistic
...
\begin{frame}{Relativistic Mass}
  ...
  mass. The \textbf{apparent mass} (or \textbf{relativistic mass}) $m'$
...
\begin{frame}
  \frametitle{Work and Energy}
  Recall the definition of work. \emph{This definition has not changed.}

  \eq{-.2in}{
    W=\int\mb{F}\cdot d\mb{x}=\int\frac{d\mb{p}}{dt}\cdot \mb{dx}
  }

  We substitute the \emph{relativistic} expression for momentum
  into the expression and then integrate. It gives a surprisingly simple
  expression:
