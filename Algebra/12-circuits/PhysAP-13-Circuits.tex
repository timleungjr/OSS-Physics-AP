...
\begin{frame}{Current}
  ...
  It is also defined as the product of \textbf{charge density} $J$ flowing past
  a surface $A$:
  ...
  \item $v$ is the average \textbf{drift velocity} of the charge carriers
...
\begin{frame}{Resistivity}
  ...
  field $E$ inside the material and the charge density $J$:
...
%  }
  ...
  \item Dielectric (non conducting material): electrons cannot move
    easily--they can only polarize themselves--the electric field are generally
...
\begin{frame}{Equivalent Resistance of Resistors in Series}
