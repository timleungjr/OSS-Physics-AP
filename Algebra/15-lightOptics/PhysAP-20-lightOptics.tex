...
\begin{frame}{Reflection and Refraction}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.8]
      ...
      \draw[rotate=45,->,red!80,very thick](0,2.5)--(0,1);
      \draw[rotate=45,red!80,very thick](0,2)--(0,0);
      \draw[rotate=-45,red!80,very thick](0,0)--(0,2.5)
      node[right]{\footnotesize Reflection};
      \draw[rotate=-45,->,red!80,very thick](0,0)--(0,1.75);
      \draw[rotate=30,red!80,very thick](0,0)--(0,-2.3)
      node[above right]{\footnotesize Refraction};
      \draw[rotate=30,->,red!80,very thick](0,0)--(0,-1);
      \draw[dashed,black!70,thick](0,2)--(0,-2);
      \draw[->,thick](0,1.5) arc(90:135:1.5) node[midway,above]{$\theta_1$};
      \draw[->,thick](0,1.2) arc(90:45:1.2) node[midway,above]{$\theta_r$};
      \draw[->,thick](0,-1.5)arc(270:300:1.5) node[pos=0,left]{$\theta_2$};
      \node at (-2,.3) {$n_1$};
      \node at (-2,-.3){$n_2$};
      \node at (2,.3) {$v_1$};
      \node at (2,-.3){$v_2$};
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=.8]
      ...
      \begin{scope}[rotate around={20:(0,1)}]
        ...
        node[pos=0,right]{\footnotesize $\theta$};
      \end{scope}
    ...
    \vspace{-.2in}\textbf{Destructive minima} occur when:
