...
\begin{frame}{Geometry of the Two-Slit Interference}
  ...
  \begin{columns}
    ...
    \vspace{-.2in}Conversely, \textbf{destructive minima} occur when:
  
    \eq{-.3in}{
      \boxed{\left(n+\frac{1}{2}\right)\lambda = d\sin\theta_n}
    }
    \begin{itemize}
    \item\vspace{-.1in}$n=0,1,2,3\ldots n_\mathrm{max}$ is called the
      \textbf{order number}
...
\begin{frame}{Soap Bubble}
  \begin{center}
    \begin{tikzpicture}[scale=.7]
      ...
      \draw[very thick,red,->]
      (1.6,5)--(2,3) node[pos=1,left]{\small $\bm{\pi}$}--(2.4,5);
      \draw[very thick,blue!80!black,->]
      (1.55,5)--(1.95,3)--(2.1,0)--(2.2,3)--(2.6,5);
      \node at (-.3,1.5 ){\small $n_\mathrm{soap}$};
      \node at (-.3,3.4){\small $n_\mathrm{air}=1$};
      \node at (-.3,-.4){\small $n_\mathrm{air}=1$};
    \end{tikzpicture}
  \end{center}
  \vspace{-.1in}Light travels through air and strikes a soap film (with
  $n_\mathrm{soap}$). On either side of the soap film is air.
  \begin{itemize}
  \item Upper interface: reflected light has a \ang{180} ($\pi$ radian)
    phase shift, as $n_\mathrm{air}<n_\mathrm{soap}$, i.e.\ light reflects from a
    fast to slow medium
...
\begin{frame}{Soap Bubble}{Condition for Interference}
  ...
  \eq{-.22in}{
    ...
    \quad\rightarrow\quad
    \boxed{
      \frac{2n_\mathrm{soap}t}{\lambda}=m+\frac{1}{2}
    }
  }
  ...
  \eq{-.22in}{
    \boxed{
      \frac{2n_\mathrm{soap}t}{\lambda}=m
    }
  }
...
\begin{frame}{Oil Film on Water}
  \begin{center}
    \begin{tikzpicture}[scale=.7]
      ...
      \draw[very thick,blue!80!black,->]
      (1.55,5)--(1.95,3)--(2.1,0)--(2.2,3)--(2.6,5);
      \node at (-.3,1.5 ){\small $n_\mathrm{oil}$};
      \node at (-.3,3.4){\small $n_\mathrm{air}=1$};
      \node at (-.3,-.4){\small $n_\mathrm{water}$};
    \end{tikzpicture}
  \end{center}
...
\begin{frame}{Anti-Reflection Coating}
  \begin{center}
    \begin{tikzpicture}[scale=.7]
      ...
      (1.6,5)--(2,3) node[pos=1,left]{\small $\bm{\pi}$}--(2.4,5);
      \draw[very thick,blue!80!black,->]
      (1.55,5)--(1.95,3)--(2.1,0) node[pos=1,left]{\small $\bm{\pi}$}--
      (2.2,3)--(2.6,5);
      \node at (-.3,1.5 ){\small $n_\mathrm{coating}$};
      \node at (-.3,3.4){\small $n_\mathrm{air}=1$};
      \node at (-.3,-.4){\small $n_\mathrm{glass}$};
    \end{tikzpicture}
  \end{center}
...
\begin{frame}{Anti-Reflection Coating}
  ...
  \eq{-.22in}{
    \boxed{
      \frac{2n_\mathrm{film}t}{\lambda}=m
    }
  }
  ...
  \eq{-.22in}{
    \boxed{
      \frac{2n_\mathrm{film}t}{\lambda}=m+\frac{1}{2}
    }
  }
