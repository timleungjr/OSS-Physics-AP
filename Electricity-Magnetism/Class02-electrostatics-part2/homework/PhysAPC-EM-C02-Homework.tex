...
\begin{multicols*}{2}
  \begin{questions}
    ...
    \begin{oneparchoices}
      ...
      \foreach \x in {0,...,4}
      \draw[gray,postaction={decorate}] (\x,0)--+(0,4);
      \draw[very thick,->] (.5,3.5) ..controls (1.8,0) and (2.2,0).. (3.5,3.5);
      \end{tikzpicture}
      \\
      \choice\begin{tikzpicture}[
        scale=.6,
      ...
      \foreach \x in {0,...,4}
      \draw[gray,postaction={decorate}] (\x,0)--+(0,4);
      \draw[very thick,->] (1,3.5) ..controls (4,2.2) and (4,1.8).. (1,.5);
      \end{tikzpicture}
      ...
      \foreach \x in {0,...,4}
      \draw[gray,postaction={decorate}] (\x,0)--+(0,4);
      \draw[very thick,->] (.5,3.5) to[out=-65,in=180] (3.5,.5);
      \end{tikzpicture}
    \end{oneparchoices}
    \columnbreak
...
\begin{center}
  \begin{tikzpicture}[scale=1.2]
    \draw[axes,dashed] (-2,0)--(2,0) node[right]{$x$};
    \draw[axes,dashed] (0,-2)--(0,2) node[above]{$y$};
