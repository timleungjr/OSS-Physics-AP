...
\begin{frame}{Gauss's Law}
  \begin{center}
    ...
    \end{tikzpicture}
  \end{center}
  Two different Gaussian surfaces over the same enclosed charge have the same
  total flux.
\end{frame}
...
\begin{frame}{Electric Fields from a Uniformly-Charged Sphere}
  ...
  with radius $R$ and a total charge of $Q$.
  %, as shown in
  %Fig.~\ref{fig:uniform-spherical-charge}.
  The charge is evenly spread over the
...
\begin{frame}{Infinitely-long charge rod with uniform density}
  ...
  %  as shown in Fig.~\ref{fig:charged-rod}.
