...
\begin{frame}{At Last!}
  \centering
  We are now on to the last two (small) topics in AP Physics C E\&M!
\end{frame}


\begin{frame}{Hall Effect}
  When electric current $I$ flows through a conductor in a magnetic field
  ...
  toward one side of the conductor. (Here, we are assuming that the charge
  carrier is positive.)
