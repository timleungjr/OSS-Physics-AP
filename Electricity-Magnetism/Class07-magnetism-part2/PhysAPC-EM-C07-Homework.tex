...
\begin{questions}
  ...
  \begin{parts}
    ...
    \vspace{\stretch1}
    \part Explain why the electrons pass through the capacitor plates
    undeflected. Support your argument with an algebraic equation
    and an appropriately drawn force diagram.
    \label{passthrough}
    \vspace{\stretch1}
      
    \part Use your equation from part \textbf{B} %(\ref{passthrough})
    to calculate the potential difference ($\Delta V$) between the capacitor
    plates.
    \vspace{\stretch1}
      
    \part Which capacitor plate has the highest potential? Justify your 
    reasoning making reference to the electric field.
    \vspace{\stretch1}
      
    \part Calculate the magnitude of the energy that is stored in the
    capacitor.
    \vspace{\stretch1}
    \newpage
    ...
    \uplevel{
      ...
      from part \textbf{B}. %(\ref{passthrough}).
    }
    
    \part Explain why the positron, traveling at the same speed as the
    electrons, will also travel straight through the device undeflected.
    Support your argument with an equation.
    \vspace{\stretch1}
      
    \part A second positron enters the apparatus at a speed of $2v$. Sketch the
    path of the positron through the capacitor plates on the figure.
    \vspace{.5in}
    ...
    \part Calculate the potential difference-to-resistance ratio of the circuit
    such that the electron will experience a force $F$ of \SI{1.3e-16}\newton.
    \vspace{\stretch1}      
      
    \part Draw a force vector on the figure to show the direction of the
...
%  \newpage
  ...
  \begin{parts}
    ...
    \part On the graph below, plot the data points for the magnetic field
    ...
    \begin{center}
      ...
      \begin{tikzpicture}[xscale=.6,yscale=.22]
        ...
        \draw[very thick,step=5] grid (25,35);
      \end{tikzpicture}
    \end{center}
    \vspace{.4in}

    \part Use the slope of your line to estimate a value of the vacuum
    permeability $\mu_0$.
  \end{parts}
  \newpage
