...
\begin{questions}
  ...
  \uplevel{
    ...
    \begin{center}
      \begin{tikzpicture}[scale=.8,thick,dashed]
    ...
    charge $+q$ located at their centre, as shown above. The inner surface has
  ...
  \uplevel{
    \centering
    \begin{tikzpicture}
      \foreach \y in {0,5} \fill[gray!30] (0,\y) rectangle +(4,.3);
      \foreach \y in {.3,5} \draw[very thick] (0,\y)--+(4,0);
      \draw[very thick] (2,5)--(2,3.5);
      \draw[fill=white,very thick] (2,3.5) circle (.22) node{X}
      node[right=5]{$+q$, $M$};
      
      \draw[fill=gray,very thick] (1.9,.3) rectangle (2.1,1);
      \draw[fill=white,very thick] (2,1) circle (.22) node{Y}
      node[right=5]{$+q$};

      \draw[|<->|,thick] (1.5,1)--(1.5,3.5) node[midway,fill=white]{$d$};
    \end{tikzpicture}
  }
  ...
  $d$ directly below sphere X. If sphere X is in equilibrium, the tension in
  the string is most nearly
  \begin{choices}
    \choice$Mg$
  ...
  \question A charge $+q$ is placed at the centre of a tetrahedron whose faces
  are all equilateral triangles, as shown below. What is the flux of the
  electric field through one face of the tetrahedron?
  \begin{choices}
    \choice 0
    \choice$q/\varepsilon_0$
    \choice$q/4\varepsilon_0$
    \choice$4\varepsilon_0q$
...
%  \end{minipage}
  ...
  \begin{minipage}{.4\linewidth}
    \begin{tikzpicture}[scale=.9]
      ...
      \draw[vectors] (7,1.5)--+(-1.5,0);
      \draw[thick,fill=lightgray] (7,1.5) circle (.2) node{\scriptsize$e^-$};
    \end{tikzpicture}
  \end{minipage}
  ...
  \uplevel{
    ...
    \begin{tikzpicture}[scale=1.2,very thick]
      \draw (0,-1.5)--(0,-.1) arc (-90:90:.1)--(0,1.5);
      \draw (-2,0)--(2,0);
      \fill (.7,.7) circle (.04) node[above]{$P$};
      \draw[vectors] (-1.2,0)--(-.8,0) node[below]{$2I$};
      \draw[vectors] (0,.8)--(0,1.2) node[left]{$I$};
    \end{tikzpicture}
  }
  ...
  \uplevel{
    \textbf{Questions \ref{contour1}--\ref{contour2}}: A fixed charge
    distribution produces the equipotential lines shown in the figure below.
    \cpic{.35}{contours}
  }
  ...
  \label{contour2}
  \begin{choices}
    \choice towards the left
    \choice towards the right
  ...
  \begin{choices}
    \choice\SI0{\volt\per\metre}
    \choice\SI4{\volt\per\metre}
  ...
  \uplevel{
    ...
    \begin{tikzpicture}[thick]
      \draw (-4,0) circle (.2) node{$\bm +$} node[below=5]{Proton};
      \draw circle (.2) node{$\bm -$} node[below=5]{Electron};
      \draw ( 4,0) circle (.2) node{$\bm +$} node[below=5]{Proton};
      \draw[<->] (-3.8,0)--(-.2,0) node[midway,fill=white]{$a$};
      \draw[<->] ( 3.8,0)--( .2,0) node[midway,fill=white]{$a$};
    \end{tikzpicture}
  }

  \question Two protons and an electron are assembled along a line, as shown
  above. The distance between the electron and each proton is $a$. What is the
  ...
  \uplevel{
    \textbf{Questions \ref{rain1}--\ref{rain2}}: A cloud contains spherical
    drops of water of radius $R$ and charge $Q$. Assume the drops are far apart.
  }
  ...
  \uplevel{
    \centering
    \begin{tikzpicture}
      \draw[axes] (-1,0)--(4,0) node[right]{\small$x$};
      \draw (0,.1)--(0,-.1) node[below]{\small0};
      \draw (1.5,.1)--(1.5,-.1) node[below]{\small$\dfrac d2$};
      \draw (3,.1)--(3,-.1) node[below]{\small$d$};
      \fill circle (.05) node[above]{\small$-Q$};
      \fill (3,0) circle (.05) node[above]{\small$+2Q$};
    \end{tikzpicture}
  }
...
%  \end{choices}
  ...
  \uplevel{
    ...
    \begin{tikzpicture}[scale=.77]
      ...
      \draw[very thick] ( 1,-3)--( 1,3);
      \draw[<->] (-1,.7)--(0,.7)  node[midway,above]{\small$r$};
      \draw[<->] (1,-.7)--(0,-.7) node[midway,below]{\small$r$};
      \draw[vectors] (-1,0)--(-1,1.5) node[left]{$I$};
      \draw[vectors] (1,0)--(1,-1.5) node[right]{$I$};
    ...
    \begin{tikzpicture}[scale=.77]
      \draw[gray,->] (-4,0)--(4,0)node[right]{$x$};
      \draw[gray,->] (0,-3)--(0,3)node[above]{$y$};
      \draw[very thick] (-4,0)--(-1,0)--(-1,3);
      \draw[very thick] (3.8,0)--(1,0)--(1,-3);
      \draw[<->] (-1,.7)--(0,.7)  node[midway,above]{\small$r$};
      \draw[<->] (1,-.7)--(0,-.7) node[midway,below]{\small$r$};
      \draw[vectors] (-1,0)--(-1,1.5) node[left]{$I$};
      \draw[vectors] (-3,0)--(-2.3,0);
      \draw[vectors] (1,0)--(1,-1.5) node[right]{$I$};
      \draw[vectors] (3,0)--(2.3,0);
      \fill circle (.07) node[below left]{$O$};
    \end{tikzpicture}
  ...
  \uplevel{
    ...
    \hspace{.3in}
    \begin{tikzpicture}
      \draw[vectors] (-2.2,0) arc(180:-200:2.2) node[above left]{$I$};
      \node at (0,-3) {Loop $Y$};
    \end{tikzpicture}
  }
  ...
  centre of loop $Y$ to the magnetic field strength at the centre of loop $X$ is
  \begin{choices}
    \choice $1/9$
    \choice $1/3$
    \choice 1
  ...
  distance $r$ from the centre of the wire. Which of the following graphs best
  ...
  \begin{oneparchoices}
    ...
    \begin{tikzpicture}[scale=1.3]
      ...
      \draw[very thick,domain=1:1.7] plot(\x,{2.72*exp(-\x)});
    \end{tikzpicture}
    \choice
    \begin{tikzpicture}[scale=1.3]
      \draw[->] (0,0)--(2,0)  node[right]{$r$};
    ...
    \begin{tikzpicture}[scale=1.3]
      ...
      \draw[->] (0,0)--(0,1.7) node[right]{$B$};
      \draw[dashed] (1,1)--(1,0) node[below]{$R$};
      \draw[very thick,domain=0:1] plot(\x,{\x*\x)});
      \draw[very thick,domain=1:1.7] plot(\x,{2.72*exp(-\x)});
    \end{tikzpicture}
    \choice
    \begin{tikzpicture}[scale=1.3]
