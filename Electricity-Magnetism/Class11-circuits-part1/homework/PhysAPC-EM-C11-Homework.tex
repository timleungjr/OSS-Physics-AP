...
\begin{questions}
  ...
  \begin{parts}
    ...
    ideal and the experiment is repeated, \textbf{indicate} whether the
    readings of the ideal ammeter would be greater than, less than, or equal to
    those in the data chart before part \textbf{C}?
