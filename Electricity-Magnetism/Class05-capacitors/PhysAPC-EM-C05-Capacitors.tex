...
\begin{frame}{Spherical Capacitor}
  ...
  \eq{-.1in}{
    |\Delta V|=\int_a^bE\dl r=\frac Q{4\pi\epsilon_0}\int_a^b\frac{\dl r}{r^2}
    =\frac Q{4\pi\epsilon_0}\left(\frac1a-\frac1b\right)
  }
\end{frame}
...
\begin{frame}{Equivalent Capacitance in Series}
  ...
  \eq{-.1in}{
    \boxed{ \frac1{C_\text{series}}=\sum_{i=1}^N\frac1{C_i} }
  }
