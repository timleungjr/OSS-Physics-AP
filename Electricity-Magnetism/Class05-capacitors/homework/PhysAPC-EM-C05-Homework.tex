...
\begin{questions}
  \question A parallel plate capacitor is connected to a battery,
  fully charged, disconnected, and isolated from the battery. A dielectric slab
  is then inserted between the plates of the capacitor. Which of the following
  is a true statement about what happens when the dielectric slab is inserted?
  \begin{choices}
  ...
  \uplevel{
    ...
    \begin{tikzpicture}[scale=.8]
      ...
      \draw[<->] (0,1)--(1,1) node[midway,below]{$d$};
      \node[above] at (.5,2){A};
    \end{tikzpicture}
    \hspace{.5in}
    \begin{tikzpicture}[scale=.8]
      \foreach \x in {0,2} \draw[thick] (\x,0)--+(0,2);
      \draw[<->] (0,1)--(2,1) node[midway,below]{$2d$};
      \node[above] at (1,2){B};
    \end{tikzpicture}
    \hspace{.5in}
    \begin{tikzpicture}[scale=.8]
  ...
  \uplevel{
    ...
    \begin{center}
      \begin{tikzpicture}[scale=.5]
        \draw[very thick] circle (1) node[above=12]{$-Q$};
        \draw[very thick] circle (3) node[above=40]{$-Q$};
        \fill circle (.13);
        \draw[axes] (0,0)--(1,0) node[pos=1.35]{$a$};
        \draw[axes,rotate=-140] (0,0)--(3,0) node[pos=1.2]{$b$};
        \begin{scope}[rotate=160]
          \draw[axes] (0,0)--(2,0) node[midway,above]{$r$};
          \fill (2,0) circle (.1);
        \end{scope}
      \end{tikzpicture}
    \end{center}
    The spherical capacitor shown above consists of a conducting shell of radius
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.45,thick]
      \draw[fill=lightgray] (-1,0)--(-3,0) arc (180:360:3)--(1,0)
      arc (0:-180:1);
      \draw circle (1);
      \draw circle (3);
      \fill circle (.1);
      \draw[axes,rotate=230] (0,0)--(1,0) node[pos=1.3]{$a$};
      \draw[axes] (0,0)--(3,0) node[pos=1.1]{$b$};
      \node at (0,3.3) (a){$+Q$};
      \node at (0,1.3) (b){$-Q$};
    \end{tikzpicture}
  \end{center}
  ...
  \uplevel{
    \textbf{Questions \ref{plate1}--\ref{plate2}}: The equation for determining
    the capacitance of a capacitor of plate area $A$ and separation $d$ is
...
\begin{questions}
  ...
  axis but off centre. An enlarged cross section of the cylindrical shell is
  shown above right.
  \begin{parts}
    \part On the cross section above right,
    \begin{subparts}
      \subpart\textbf{sketch} the electric field lines, if any, in each of
      regions I, II, and III and
      \subpart use $+$ and $-$ signs to \textbf{indicate} any charge induced
      on the conductor.
      \end{subparts}
    ...
    \vspace{.1in}
    \underline{\hspace{.3in}} $V_a$\hspace{.5in}
    \underline{\hspace{.3in}} $V_b$\hspace{.5in}
    \underline{\hspace{.3in}} $V_c$\hspace{.5in}
    \underline{\hspace{.3in}} $V_d$\hspace{.5in}
    \underline{\hspace{.3in}} $V_e$
    ...
    located at the centre of the shell as shown above. Using Gauss's law,
    \textbf{determine} the magnitude of the electric field as a function of the
    distance $r$ from the centre of the shell for each of the following
    regions. Express your answers in terms of the given quantities and
  ...
  \begin{parts}
    \part Use Gauss's law to \textbf{prove} that the electric field inside the
    shell is zero everywhere. Describe the Gaussian surface that you use.
    \vspace{\stretch1}
    ...
    \uplevel{
      Now consider a small conducting sphere with charge $+Q$ whose centre is at
    ...
    \vspace{.1in}\textbf{Explain} your reasoning.
    \vspace{\stretch1}
    
    \part At which corner(s) of the surface does the electric field have the
    least magnitude? \textbf{Justify} your answer.
    \vspace{\stretch1}
    
    \part\textbf{Determine} the electric field strength at the position(s) you
    have indicated in part \textbf{D} in terms of $Q$, $L$, and fundamental
    constants, as appropriate.
    \vspace{\stretch1}
    
    \part Given that one-eighth of the sphere at point A is inside the surface,
    \textbf{determine} the electric flux through face $CDEF$.
    \vspace{\stretch1}
  ...
  \begin{parts}
    \part Using Gauss's law, \textbf{derive} an expression for the magnitude of
    the electric field at a radius $r<R$. Draw an appropriate Gaussian surface
    on the diagram.
    \vspace{\stretch1}
    ...
    \part On the axes below, \textbf{sketch} the graph of electric field $E$ as
    a function of radial distance $r$ for $r=0$ to $r=2R$. Explicitly
    ...
    \uplevel{
      ...
      \begin{tikzpicture}[scale=1.2]
        \draw[axes] (0,0)--(5,0) node[right]{$r$};
        \draw[axes] (0,-2)--(0,2) node[above]{$E$};
    ...
    \part
    \begin{subparts}
      \subpart\textbf{Derive} an expression for the magnitude of the potential
    ...
    the same shape and same linear charge density. On the axes below,
    \textbf{sketch} the electric field $E$ as a function of $r$ for $r=0$ to
    $r=2R$. Explicitly \textbf{label} any intercepts, asymptotes, maxima, or
