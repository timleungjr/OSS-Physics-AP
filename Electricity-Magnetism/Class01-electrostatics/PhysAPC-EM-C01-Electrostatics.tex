...
\title{Class 1: Electrostatics, Part 1 (Point Charges)}
...
\begin{frame}{Infinitesimal Charge $\dl q$}
  ...
  mass $\dl m$ introduced in AP Physics C--Mechanics. The densities do not
  have to be uniform (constant)
  %\footnote{At Meritus, this
  %is discussed in Class 5: Centre of Mass, and Class 7: Rotational Motion in
