...
%      \end{scope}
      ...
      \shade[ball color=red] circle (.35) node[white]{$Q$};
    \end{tikzpicture}
...
\begin{frame}{Infinitesimal Charge $\dl q$}
  ...
  mass $\dl m$ introduced in AP Physics C--Mechanics.\footnote{At Meritus, this
  is discussed in Classs 6: Centre of Mass, and Class 9: Rotational Motion} The
  densities do not have to be uniform (constant)
  \begin{itemize}
...
\begin{frame}{Electric Field}
  ...
  procedure as with gravitational field\footnote{Again a topic discussed in
  Physics C: Mechanics}, by grouping the variables in Coulomb's law:
...
\begin{frame}{Electric Potential: Using Gravity as Example}
  ...
  i.e.\ this is really a \emph{function} of $gh$} $V_g$ is called the
