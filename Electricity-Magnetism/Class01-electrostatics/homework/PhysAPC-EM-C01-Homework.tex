...
\begin{questions}
  \question Two fixed charges $A$ and $B$ are separated by a distance $r$. The
  electric force on charge $B$ by charge $A$ has a magnitude $F$. Which of the
  following statement(s) \textbf{must} be correct?
  ...
  \uplevel{
    ...
    \begin{tikzpicture}[scale=1.3]
      ...
      \fill (.8,0) circle (.06) node[above]{$A$};
      \fill (1.6,0) circle (.06) node[above]{$B$};
      \fill (3.2,0) circle (.06) node[above]{$C$};
    \end{tikzpicture}
    \vspace{.1in}
  }
  \question Three point charges, $A$, $B$ and $C$ are fixed along a straight
  line, as shown in above figure. The resultant electric force on charge $B$ is
  zero. Which of the following statement(s) \textbf{must} be correct?
  \begin{enumerate}[label=\Roman*.,nosep]
  ...
  \item The electric force on charge $B$ by charge $A$ is half of that by
    charge $C$.
  \item The magnitude of charge carried by charge $C$ is 4 times that of charge
    $A$.
  \end{enumerate}
  \begin{choices}
    \choice I only
  ...
  \begin{choices}
    ...
    sphere.
    \choice The charge is concentrated at the centre of the sphere.
  ...
  \begin{choices}
    ...
    \choice The electric field is maximum at the centre of the sphere.
  ...
  \uplevel{
    ...
    placed at the centre of a hollow conducting sphere.
    \begin{center}
      \begin{tikzpicture}[scale=1.1]
        \draw[thick] circle (1.2);
        \fill circle (.08) node[right]{$Q$};
      \end{tikzpicture}
    \end{center}
  }
  ...
  \uplevel{
    ...
    \begin{tikzpicture}[scale=1.1]
      ...
      \shade[ball color=gray!50] (.5,0) circle (.15) node[above=3]{$+4Q$};
      \shade[ball color=gray!50] (1.5,0) circle (.09) node[above=3]{$-Q$};
    \end{tikzpicture}
  }
  ...
  direction of the electric field at the centre of the triangle?
  \begin{center}
    \vspace{-.1in}
...
\begin{center}
  \begin{tikzpicture}
    ...
    node[pos=.65,right=-1,black]{$\theta$};
...
\begin{questions}
  ...
  \begin{parts}
    ...
    the vacuum permittivity $\varepsilon_0$ when\\
    $M=\SI{.0050}{\kilo\gram}$ and $Q=q=\SI{6.0e-8}\coulomb$.
    \vspace{\stretch1}
    \newpage
  ...
  \uplevel{
    ...
    \begin{tikzpicture}[scale=1.7]
      ...
      \fill (.37,.23) circle (.05);
      \fill (1.25,.7) circle (.05);
      \fill (2,1.25) circle (.05);
      \fill (2.97,2.47) circle (.05);
      \fill (4.12,3.75) circle (.05);
    \end{tikzpicture}
  }
  \begin{parts}
...
%  function of the distance $r$ from the centre of the sphere is given by the
%  following
%  \begin{align*}
