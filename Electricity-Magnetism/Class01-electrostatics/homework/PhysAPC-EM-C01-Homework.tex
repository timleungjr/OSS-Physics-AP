...
\begin{multicols*}{2}
  \begin{questions}
    ...
    \question Which of them will have more kinetic enegy when they collide?
    \label{pair2}
    \begin{choices}
      \choice The proton
      \choice The electron
...
\begin{center}
  \begin{tikzpicture}[scale=1.2]
    ...
    \draw[thick,dashed,->](0,-2)--(0,2) node[above]{$y$};
    \draw[thick,dashed] circle(1.3);
    \begin{scope}[rotate=135]
      \draw[line width=.8mm](1.3,0) arc(0:90:1.3) node[pos=.3,left]{$+Q$};
      \draw[thick,dashed,<->](0,0)--(1.3,0) node[pos=.65,below]{$R$};
    \end{scope}
