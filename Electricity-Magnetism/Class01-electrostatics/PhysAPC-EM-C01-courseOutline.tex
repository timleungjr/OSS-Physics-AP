...
\renewcommand{\coursetitle}{AP Physics C (E\&M)}
\renewcommand{\term}{Winter 2026}

\title{AP Physics C (Electricity \& Magnetism) Course Outline}
...
The AP Physics C (E\&M) course at Meritus Academy is a calculus-based physics
course that runs for a total of 40 hours (sixteen 2.5-hour classes). There is
also an online AP Physics C (Mechanics) course that runs concurrently. For the
Winter 2026 term, the course runs once a week online. In addition to the
regular class time, there is a weekly online drop-in tutorial (shared with AP
Physics 1 and 2) for students to ask course-related questions. Zoom link for the
tutorial can be found in the student account or from your teacher.
...
\begin{center}
  \begin{tabular}{|p{1.9in}|c|c|c|}
    ...
    Fridays & 7:00 to 8:00 pm & January 23 to May 2, 2026 \\
    \hline
  \end{tabular}
\end{center}
\egroup
...
covered, with some exceptions. Homework sets usually have 15 to 20 questions,
consisting of multiple-choice, general problem-solving, and AP-style
``free-response'' questions. Questions are based on university-level problems,
as well as past AP and IB exams. Homework sets are posted on the school's
website as well as on \texttt{classkick.com}, and normally due at the end of
the following class. Some homework questions (only free-response questions)
...
\begin{itemize}[nosep]
\item An in-class test on Class 9, covering topics from Classes 1 to 7, and
\item A second in-class test on Class 6, covering all
...
\begin{center}
  \begin{tabular}{|c|c|p{4in}|c|}
    ...
    \textbf{Homework Due} \\
    \hline\hline
    1  & January 18  & Electrostatics (1) & --- \\ \hline
    2  & January 25  & Electrostatics (2) & HW 1\\ \hline
    3  & February 1  & Gauss's Law (1)    & HW 2 \\ \hline
    4  & February 8  & Gauss's Law (2)    & HW 3 \\ \hline
    5  & February 15 & Capacitors (1)     & HW 4 \\ \hline
    6  & February 22 & Capacitors (2) and Magnetism (1) & HW 5 \\ \hline
    7  & March 1 & Magnetism (2): Amp\`{e}re's Law and magnetic force & ---
    \\ \hline
    8  & March 8 & Magnetism (3): Magnetic Induction & HW 6\&7 \\ \hline
    \rowcolor{lightgray!50}
    9  & March 15 & \textbf{Practice Test 1} & HW 8 \\ \hline
    10 & March 22 & Magnetism (4)            & ---  \\ \hline
    11 & March 29 & DC circuit analysis (1)  & HW 10 \\ \hline
    12 & April 5  & DC circuit analysis (2)  & HW 11 \\ \hline
    13 & April 12 & DC circuit analysis (3)  & HW 12 \\ \hline
    14 & April 19 & Hall effect and Maxwell's equations & HW 13 \\ \hline
    15 & April 26 & Course Review & --- \\ \hline
    \rowcolor{lightgray!50}
    16 & May 3 & \textbf{Practice Test 2}   & HW 14 \\ \hline
...
\item Have your camera turned on showing your face when class starts
...
\item For multiple-choice questions (MCQs), please answer them directly on the
  ...
  new to the school, you will need to create a ``Portfolio account''; if you
  have taken any online courses with us before, simply reuse your account.} by
  selecting your answer with your mouse. You are not required to show work.
