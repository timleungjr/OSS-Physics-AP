...
There is also a weekly online drop-in tutorial (shared with AP Physics 1)
%and 2)
for students for course-related questions. Zoom link for the tutorial
...
(only free-response questions) will be reviewed during class time before the
questions are due.
...
\end{itemize}
The format of the tests will be similar to the AP exams, however, in-class
practice tests will be substantially shorter
...
\begin{center}
  \begin{tabular}{|c|c|p{4in}|c|}
    ...
    5  & October 12 & Capacitors (1) & HW 4 \\ \hline
    6  & October 19 & Capacitors (2) and Magnetism (1) & HW 5 \\ \hline
    7  & October 26 & Magnetism (2): Amp\`{e}re's Law and magnetic force & ---
    \\ \hline
    8  & November 2  & Magnetism (3): Magnetic Induction & HW 6\&7 \\ \hline
    \rowcolor{lightgray!50}
    9  & November 9  & \textbf{Practice Test 1} & HW 8    \\ \hline
    10 & November 16 & Magnetism (4) & ---  \\ \hline
