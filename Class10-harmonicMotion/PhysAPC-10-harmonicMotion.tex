...
\begin{frame}{It's Never Perfect}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.1]
      \node[draw,thick,fill=cyan!20!white,inner sep=5.5mm] (a) at (3.5,1);
      ...
      \uncover<3->{
        ...
        \draw[vectors,red!60] (3.5,1)--(3.5,0) node[below]{$m\vec g$};
        \draw[vectors,red!60] (3.5,1)--(3.5,2) node[above]{$\vec N$};
        \draw[vectors,red!60] (3.5,1)--(2.5,1) node[above]{$\vec F_s$};
        \draw[vectors,red!70!black] (3.5,1)--(4.5,1) node[above]{$\vec F_D$};
      }
    \end{tikzpicture}
  \end{center}
  \uncover<4->{
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \begin{scope}[very thick,->,red]
        ...
        \draw[red!60](3.5,1)--(2.5,1) node[above]{$\vec F_s$};
