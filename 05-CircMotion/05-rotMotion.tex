...
\begin{frame}
  ...
  \begin{columns}
    ...
    {\LARGE
      \begin{align*}
        \Delta\theta&=\omega_1 t + \frac{1}{2}\alpha t^2\\
        \Delta\theta&=\omega_2 t - \frac{1}{2}\alpha t^2
      \end{align*}
    }
    ...
    {\LARGE
      \begin{align*}
        \Delta\theta&=\frac{\omega_1+\omega_2}{2} t\\
...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.5]
      \fill[black!75,draw=black,ultra thick] (-2,-.15) rectangle (2,.15);
