...
\item A uniform ball of radius $r$ rolls without slipping along the
  ...
  \begin{center}
    \pic{.45}{roll-ball.png}
  \end{center}
  \begin{enumerate}[itemsep=1.2in,topsep=0pt,leftmargin=15pt]
  \item\vspace{-.3in}If it is not to leave the track at the top of the loop, what is the
