  ...
  \begin{questions}
    ...
    \begin{center}
      \begin{tikzpicture}[scale=1.3,thick]
        ...
        \draw[->](.075,2)--(.075,3) node[above]{$I_A$};
        \draw[->](1.075,2)--(1.075,3) node[above]{$I_B$};
      \end{tikzpicture}
    \end{center}
    \begin{choices}
...
\begin{questions}
  ...
  \begin{parts}
    ...
    \part Use your equation from (\ref{passthrough}) to calculate the
