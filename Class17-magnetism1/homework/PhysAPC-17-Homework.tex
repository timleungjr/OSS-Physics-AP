...
<<<<<<< HEAD
      \begin{tikzpicture}
        \draw[thick,->](0,4)--(0,2.5) node[right]{$I$};
        \draw[thick](0,3)--(0,0);
        \fill(-.5,2) circle(.1) node[above left] {$e$};
    ...
    \uplevel{
      ...
      \begin{center}
        \begin{tikzpicture}[scale=.9]
          ...
          \draw[thick,->](1.5,2.5)--(.5,2.5) node[left]{$\varv$};
        \end{tikzpicture}
      \end{center}
    }
...
<<<<<<< HEAD
<<<<<<< HEAD
\genfreetitle{17}{MAGNETISM, PART 1}{3}
...
\begin{center}
  \begin{tikzpicture}[american voltages,scale=1.2]
    ...
    to[battery1=$\varepsilon$](2,2.5)--(2,1) node[midway,right]{$d$};
...
>>>>>>> bada03f (Lots of changes for Fall 2022. Mostly shortening homework sets)
  ...
  \begin{parts}
    ...
    \begin{center}
      \begin{tikzpicture}[american voltages,scale=1.2]
        \draw(0,-.5)--(0,1)--(4,1)--(4,-.5) to[battery1=$\varepsilon$] (2,-.5)
        to[R=$R$] (0,-.5);
...
%  \newpage
  ...
  \begin{parts}
    ...
    \begin{subparts}
      ...
      \end{center}
      \vspace{.4in}
      \subpart Use the slope of your line to estimate a value of the vacuum
      permeability $\mu_0$.
    \end{subparts}
  \end{parts}
  \newpage
