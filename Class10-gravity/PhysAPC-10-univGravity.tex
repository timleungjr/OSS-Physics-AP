...
\begin{frame}{More Than One Mass}
  \begin{columns}
    ...
    is the vector sum of all the forces $\vec F_i$:
...
%
\begin{frame}{Kepler's Second Law: Law of Equal Areas}
%  We can express $\vec r\times\vec{v}$ in terms of angular momentum,
%  $\vec{L}=m(\vec r\times\vec{v})$. But in motion under any central force (such
