...
\begin{frame}
  ...
  The actual (real) mass has not increased, but a moving observer will note
  that the object behaves as if it is more massive.
  %Mass increases with velocity. At $v=c$, $m=\infty$!
\end{frame}
...
\begin{frame}
  ...
  to the change in kinetic energy $K$
\end{frame}

\begin{frame}
  \frametitle{Relativistic Energy}

  \eq{-.1in}{ \boxed{K=m'c^2-mc^2} }
