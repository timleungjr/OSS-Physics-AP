...
\question A planet of mass $M$, radius $R$, and uniform density has a small
  ...
  \begin{parts}
    ...
    \vspace{.2in}
    \underline{\hspace{.5in}}More time\hspace{.3in}
    \underline{\hspace{.5in}}Less time\hspace{.3in}
    \underline{\hspace{.5in}}Same amount of time
  ...
  \begin{parts}
    ...
    \underline{\hspace{.5in}} Less than
