...
\begin{frame}{Internal Energy}
  ...
  potential energies at the molecular level:
  
  \eq{-.1in}{
    \boxed{ E_\text{int}=K_\text{micro} + U_\text{micro} }
  }

  It is proportional to the molecules' \textbf{absolute temperature}. This is
...
\begin{frame}{Law of Conservation of Energy}
  ...
  Not suprisingly, the \emph{change} in system enenrgy is the net change
