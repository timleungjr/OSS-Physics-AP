...
\begin{frame}{Centre of Mass During Collision}
  ...
  constant. Consider this 1D inelastic collision in between two masses:
  \begin{center}
...
\begin{frame}{Acceleration of the Centre of Mass}
  Taking the derivative of net momentum with respect to time\footnote{i.e\
  applying the 2nd law of motion to this distribution of masses}:
