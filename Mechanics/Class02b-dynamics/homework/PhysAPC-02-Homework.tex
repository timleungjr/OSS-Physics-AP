...
%  \newpage
  ...
  \begin{parts}
    ...
    \part On the axes below, sketch graphs of the speed $v$ and displacement
    $x$ of the block as functions of time $t$ if the block started from rest at
    $x=0$ and $t=0$.
  ...
  \begin{parts}
    ...
    components) that act on the box. Forces should be drawn as arrows starting
    at, and pointing away from, the dot.
    \vspace{.7in}
    \begin{center}
      {\tikz\fill circle(.15);}
    \end{center}
    ...
    to determine the speed $v$ of the box as a function of time $t$. If you
    ...
    \part Use the differential equation from part (b) to derive the equation
    for the speed $v$ of the box as a function of time $t$. Assume that $v=0$
    at time $t=0$.
    \vspace{\stretch1}
    \newpage
    
    \part On the axes below, sketch a graph of the speed $v$ of the box as a
...
%    \vspace{\stretch1}
%    
%    \part Derive an expression for the speed $v_D$ of the passenger compartment
...
%  \begin{parts}
%    \part Derive an expression for the speed $v_h$ of the hanging block as
...
%    \vspace{\stretch1}
%    
%    \part Derive an expression for the speed $v_r$ of the rope as a function of
%    $y$.
%    \vspace{\stretch1}
%    
...
%  \end{parts}
  ...
  \begin{parts}
    ...
    \part Use the best-fit line to calculate an experimental value for $B$
    \vspace{\stretch1}
  \end{parts}
