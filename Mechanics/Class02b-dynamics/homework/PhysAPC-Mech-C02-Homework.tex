...
%    \label{q:2blocks2}
    ...
    \question A block of mass \SI4{\kilo\gram} slides down a rough incline
    ...
    \uplevel{
      ...
      \begin{center}
        \begin{tikzpicture}[scale=1.2,thick]
          ...
          \begin{scope}[rotate=-30]
            \draw (-2,0) rectangle (-2.8,.8);
            \draw[very thick,->] (-2,1)--(-2.8,1) node[left]{$v$};
          \end{scope}
        \end{tikzpicture}
      \end{center}
    }
...
%  \newpage
  ...
  \begin{parts}
    ...
    you need to draw anything other than what you have shown in part
    (\ref{fbd}) to assist in your solution, use the space below. Do NOT add
    anything to the figure in part (\ref{fbd}).
    \label{diffeq}
    \vspace{\stretch1}
    ...
    \part Use the differential equation from part (\ref{diffeq}) to
...
%  \end{parts}
  ...
  \uplevel{
    \centering
    \begin{tikzpicture}
      \draw ellipse (.5 and 1);
      \draw (3,-1) arc (-90:90:.5 and 1);
      \foreach \y in {-1,1} \draw (0,\y)--+(3,0);
  ...
  \begin{parts}
    ...
    \vspace{.15in}
    \underline{\hspace{.75in}} Greater than\hspace{.2in}
    \underline{\hspace{.75in}} Less than\hspace{.2in}
    \underline{\hspace{.75in}} Equal to

    \vspace{.15in}Briefly \textbf{justify} your answer.
    \vspace{\stretch1}
