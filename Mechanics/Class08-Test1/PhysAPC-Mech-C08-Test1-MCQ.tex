...
\begin{center}
  {
    ...
    \textbf{AP PHYSICS C: MECHANICS \\SECTION I \\TIME -- 50 MINUTES}
  }
\end{center}
...
\vspace{.1in}\textbf{Note:} To simplify calculations, you may use
...
\begin{questions}
  ...
  \question Which of the following best shows a graph of position $x$ versus
  time $t$ for the car?
  ...
  \question\vspace{-.1in}The graph above shows the net force acting on an
  object as a function of time. The change in momentum of the object from time
  0 to $t$ is
  \begin{choices}
    \choice $2Ft$
    \choice $Ft$
