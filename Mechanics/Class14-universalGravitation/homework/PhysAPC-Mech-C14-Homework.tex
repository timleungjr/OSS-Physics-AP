...
\gentitle{14}{UNIVERSAL GRAVITATIONAL \& PLANETARY MOTION}
...
%    \end{choices}
  ...
  closest approach at a distance $a$, and its farthest distance $b$. The speed
  of the moon at point $b$ is $v$. The speed at point $a$ is
  \begin{choices}
    \choice $\dfrac{av}b$
    \choice $\dfrac{bv}a$
  ...
  planet of mass $M$. The satellite has a speed $v$ when it is closest to the
  planet at a distance $r$. Work is done by the engines of the satellite to
  change its orbit to a circular orbit when it is at this distance $r$. Which
  of the following statements is true of the transition from an elliptical
...
\begin{questions}
  ...
  tunnel drilled through the centre of the planet, as shown above. When the
  ...
  \begin{parts}
    ...
    centre, \textbf{calculate} the mass's potential energy as a function of
    distance from the centre of the planet $U(r)$, for values $r<R$.
    \vspace{\stretch1}
    ...
    \part If the mass is dropped from $R$ from the centre of the planet,
    \textbf{determine} how long will it take until it returns to its original
    position.
    \vspace{\stretch1}

    \newpage
    \part If the mass is dropped from $R/2$ from the centre of the planet,
    ...
    \vspace{.1in}
    \underline{\hspace{.3in}} More time\hspace{.5in}
    \underline{\hspace{.3in}} Less time\hspace{.5in}
    \underline{\hspace{.3in}} Same amount of time

    \vspace{.1in}\textbf{Justify} your answer.
    \vspace{\stretch1}
    
    \part If the mass is dropped from $2R$ from the centre of the planet,
    \textbf{indicate} whether it will require more, or less, or the same amount
    of time to return to its original position compared to if it was dropped
    from $R$.
  ...
  \begin{parts}
    ...
    figure. ($J$ is the centre of Jupiter, the dashed circle is the desired
