...
%There is also an AP Physics C Electricity \&
%Magnetism course that runs concurrently.
For the Summer 2025 term, the course runs twice a week online.
%There is also a weekly optional drop-in tutorial
There are also two weekly optional drop-in tutorials
(shared with AP Physics 1 and 2) for students to ask course-related questions.
Zoom link for the tutorial can be found in your student account.
...
\begin{center}
  \begin{tabular}{|p{1.9in}|c|c|c|}
    ...
    \hspace{.1in}Tuesdays \& Fridays\hspace{.1in} &
    \hspace{.1in}7:00 to 9:30 pm\hspace{.1in} &
    July 1 to August 22 \\
    \hline
    
    \multirow{2}{*}{\textbf{Drop-in tutorial (optional)}} &
    Wednesdays & 12:00 to 1:00 pm & July 2 to August 20 \\
    & Saturdays & 7:00 to 8:00 pm & July 5 to August 23 \\
    \hline
  \end{tabular}
\end{center}
\egroup
...
Since this is the first time that we are using this new couse format, the dates
...
\begin{center}
  \begin{tabular}{|c|c|p{4in}|c|}
    ...
    \textbf{Homework Due} \\
    \hline\hline
    1  & July 1    & Kinematics & --- \\ \hline
    2  & July 4    & Graphing techniques, Dynamics & HW 1\\ \hline
    3  & July 8    & Multi-body dynamics, Work and energy (Part 1) & HW 2 \\ \hline
    4  & July 11   & Work and energy (Part 2) & HW 3 \\ \hline
    5  & July 16   & Momentum, Impulse and Collisions & HW 4 \\ \hline
    6  & July 18   & Centre of Mass & HW 5 \\ \hline
    7  & July 22   & Circular Motion & HW 6 \\ \hline
    \rowcolor{lightgray!50}
    8  & July 26   & \textbf{In-Class Practice Test 1} & HW 7    \\ \hline
    9  & July 29   & Rotational motion (Part 1)  & ---   \\ \hline
    10 & August 1  & Rotational motion (Part 2) & HW 9  \\ \hline
    11 & August 5  & Rotational motion (Part 3) & HW 10 \\ \hline
    12 & August 8  & Harmonic motion (Part 1) & HW 11 \\ \hline
    13 & August 12 & Harmonic motion (Part 2)   & HW 12 \\ \hline
    14 & August 15 & Universal gravitation      & HW 13 \\ \hline
    15 & August 19 & Planetary motion, and course review & HW 14 \\ \hline
    \rowcolor{lightgray!50}
    16 & August 22 & \textbf{In-Class Practice Test 2}   & HW 15 \\ \hline
  \end{tabular}
\end{center}
\egroup
