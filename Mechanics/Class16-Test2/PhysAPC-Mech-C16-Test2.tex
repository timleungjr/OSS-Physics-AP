...
\begin{questions}
  ...
  \begin{tabular}{clll}
    & \underline{Magnitude of Velocity}
    & \underline{Magnitude of Acceleration}
    & \underline{Distance of Fall Each Second}\vspace{.05in}\\
  ...
  \begin{choices}
    \choice \SI{6}{\kilo\gram\metre\per\second}
  ...
  \begin{choices}
    \choice $\frac13\omega_0$
    \choice $\frac12\omega_0$
    \choice $\frac23\omega_0$
    \choice $\frac45\omega_0$
    \choice $\frac2{\sqrt5}\omega_0$
    \end{choices}
  ...
  \uplevel{
    \textbf{Question \ref{car1}--\ref{car3}}
    \begin{center}
      \pic{.3}{car-turning}\\
      \underline{Note:} Figure not drawn to scale.
    \end{center}
    A car is traveling clockwise around a circular racetrack of
    radius \SI{1440}\metre. When the car is at the northernmost point on the
    circle, as shown above, it has a speed of \SI{36.0}{\metre\per\second} and
    is slowing down at a rate of \SI{1.20}{\metre\per\second\squared}.
  }
  ...
  \begin{tabular}{cll}
    & \underline{Pendulum} & \underline{Spring}\vspace{.07in} \\
