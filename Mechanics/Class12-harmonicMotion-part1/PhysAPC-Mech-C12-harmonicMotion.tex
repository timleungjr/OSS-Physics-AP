...
\begin{frame}{Horizontal Spring-Mass System}
  ...
  We can take the time derivatives $x(t)$ to obtain the velocity and
...
\begin{frame}{Periodic vs.\ Simple harmonic}
  A simple harmonic motion is periodic, but not all periodic motions are
  simple harmonic motions. To ``qualify'' a periodic motion as simple harmonic,
  we require a restoring force in the form of Hooke's law.
\end{frame}
