...
\begin{questions}
  ...
  \begin{parts}
    ...
    \begin{center}
      ...
      \hspace{1.75in}
      \begin{tikzpicture}[scale=.7]
        \draw[fill=gray!30] (1.5,-4) rectangle (2.5,-5) node[midway]{$m$};      \end{tikzpicture}
      \vspace{.4in}
    \end{center}
  ...
  \begin{parts}
    ...
    numerical values for the given quantities and your answer to part
    \textbf{D}, can be used to determine the rotational inertia of the pulley.
    The pulley is removed from its support and its rotational inertia is found
    to be greater than this value. Give one \textbf{explanation} for this
    discrepancy.
    \vspace{\stretch2}
  \end{parts}
  \newpage

  % TAKEN FROM 2012 AP PHYSICS C MECHANICS QUESTION #3.
  \uplevel{
    \centering
    \begin{tikzpicture}
