...
\begin{minipage}{.43\linewidth}
  \begin{tikzpicture}[scale=1.3]
    ...
    \shade[ball color=red,opacity=.3] circle(1.5);
    \draw[thick,->,rotate=60](0,0)--(1.45,0)node[above]{$R$};
    
    \draw[thick,->,rotate=-20](0,0)--(1,0)node[midway,below left]{$r_i<R$};
    \draw[dashed,thick] circle(1);

    \draw[thick,->,rotate=20](0,0)--(2.15,0)node[right]{$r_0>R$};
    \draw[dashed,gray,thick] circle(2.15);
  \end{tikzpicture}
\end{minipage}
...
\begin{center}
  \begin{tikzpicture}
    \draw[very thick,->](0,0)--(8,0) node[right]{$r$};
    \draw[very thick,->](0,0)--(0,4) node[above]{$E$};
    \draw[thick,dashed](2.5,4)--(2.5,0) node[below]{$R$};
  \end{tikzpicture}
\end{center}
\newpage
...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw[thick,dashed](2.5,4.5)--(2.5,0) node[below]{$R$};
  \end{tikzpicture}
\end{center}
\newpage
...
O%    \begin{scope}[rotate around={-33.7:(2.03,3)}]
%      \draw[->,ultra thick,red](2.03,3)--(2.03,1.5)
%      node[midway,below right]{$\vec F_g$};
%    \end{scope}
%    \draw[->,thick](2,3)--(3,2.8) node[pos=1,right]{$\vec\varv$};
...
%      node[pos=.45,below]{$\vec r$} node[pos=1,left]{$\vec\varv_r$};
%      \draw[->](7.65,0)--(7.65,.85) node[below]{$\vec\varv_\theta$};
