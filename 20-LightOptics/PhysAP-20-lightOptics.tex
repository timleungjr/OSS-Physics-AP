...
\begin{frame}{Reflection and Refraction}
  %When we consider the \textbf{reflection} and \textbf{refraction} of light,
  ...
  light in a vaccuum and in the medium:
...
\begin{frame}{Dispersion of Light}
  ...
  called \textbf{disperson}. The dispersion of light through a prism is why we
...
\begin{frame}{Geometry of the Two-Slit Interference}
  ...
  \begin{itemize}
  \item\textbf{Constuctive inteference:} path difference is an integer multiple
    of $\lambda$
...
\begin{frame}{Geometry of the Two-Slit Interference}
  ...
  \begin{columns}
    ...
    \item $n_\mathrm{max}$ can be found by setting $\sin\theta=1$
      \begin{itemize}
      \item The nubmer of maxima is $2n_\mathrm{max}+1$
...
\begin{frame}{Approximation of The Wavelength of Light}
  ...
  And the distance between frindges is given by:
...
\begin{frame}{Geometry for Single-Slit Diffraction}
  ...
  \vspace{.2in}\begin{columns}
    ...
    \item Therfore, there is a bright fringe at the middle, called the
