...
\begin{frame}{Second Law of Motion}
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \textcolor{red!80!black}{This equation is also a ``special case'' that
    assumes that mass is constant}
    ...
    \begin{center}
      \begin{tikzpicture}[scale=.9]
        ...
        \begin{scope}[rotate around={37:(-1,0)}]
          ...
          \fill(1.5,1) circle (2pt) node[right]{\footnotesize\textbf{CM}};
...
\begin{frame}{Free Body Diagrams}
  \textbf{Step 1:} Draw a ``big dot'' to represent the CM of the
  ...
  \begin{center}
      \begin{tikzpicture}[scale=.8]
        ...
        \fill[black] (1.5,1) circle(.1) node[above]{\footnotesize CM};
        \uncover<2>{
