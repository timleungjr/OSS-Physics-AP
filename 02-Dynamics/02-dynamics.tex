...
\begin{frame}{Gravity}
  ...
  \item $\mb{F}_g$ always points \textbf{down} (the direction of $\mb{F}_g$ is
    how the concept of down is \emph{defined})
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.8]
      ...
      \fill[black] (1.5,1) circle(.1);
        \draw[->](3.5,.5)--(4.5,.5) node[pos=1,right]{\tiny $x$};
        \draw[->](3.5,.5)--(3.5,1.5) node[pos=1,above]{\tiny $y$};
        \draw [->,very thick] (1.5,1)--(1.5,-.5) node[pos=1,below]{$\mb{F}_g$};
        \draw [->,very thick] (1.5,1)--(1.5,2.5) node[pos=1,above]{$\mb{F}_N$};
        \draw [->,very thick] (1.5,1)--(3.1,1) node[pos=1,below]{$\mb{F}_a$};
        \draw [->,very thick] (1.5,1)--(.75,1) node[pos=1,left]{$\mb{F}_f$};
    \end{tikzpicture}
  \end{center}
\end{frame}
