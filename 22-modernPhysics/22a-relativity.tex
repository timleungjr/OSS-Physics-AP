...
%
%\begin{frame}
%  \frametitle{What Everyone Knows}
%  {\fontsize{60}{70}
%    \begin{displaymath}
%      \boxed{E=mc^2}
%    \end{displaymath}
...
%
%  \vspace{0.2in}
%  Most people know about \emph{this} about the theory of relativity, but what
%  does it actually mean?
%\end{frame}
%
%\begin{frame}
%  \frametitle{Starting with The Story}
%  \begin{itemize}
%  \item We start with how Einstein came up with this theory
%  \item It's a very interesting story
%  \item Shows us many aspects about how physics is done
%  \item We'll learn a lot more about relativity than most schools can teach
%  \end{itemize}
%\end{frame}
