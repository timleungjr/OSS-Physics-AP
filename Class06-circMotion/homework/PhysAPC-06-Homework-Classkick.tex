...
%    \columnbreak
    ...
    \question The linear speed $\varv$ of the ball at $t=\SI3\second$ is
    \begin{choices}
    ...
    \uplevel{
      \begin{center}
        \begin{tikzpicture}[scale=2]
          ...
          \draw[thick](0,0)--(1,0);
          \draw[thick,fill=white](1,0) circle(.08) node[right=3]{$X$};
          \draw[dashed,thick](0,0)--(-1,0);
          \draw[dashed,thick,fill=white](-1,0) circle(.08) node[left=3]{$Z$};
          \draw[dashed,thick](0,0)--(0,-1);
          \draw[dashed,thick,fill=white](0,-1) circle(.08) node[below=3]{$Y$};
          \fill circle(.03);
        \end{tikzpicture}
      \end{center}
    }
