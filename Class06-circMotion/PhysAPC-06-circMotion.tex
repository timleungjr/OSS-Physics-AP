  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=.75]
      ...
      \begin{scope}[very thick,->]
        \draw(0,0)--(1,0) node[below]{\footnotesize$\iii$};
        \draw(0,0)--(0,1) node[left]{\footnotesize$\jjj$};
      \end{scope}
      \draw (0,0) circle(2.5);
...
\begin{frame}{Polar Coordinate System in 2D}
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=.75]
      \draw[->](-3,0)--(3,0) node[right]{\footnotesize$x$};
      \draw[->](0,-3)--(0,3) node[above]{\footnotesize$y$};
      \draw[very thick,->](0,0)--(1,0) node[below]{\footnotesize$\iii$};
      \draw[very thick,->](0,0)--(0,1) node[left]{\footnotesize$\jjj$};
      \draw (0,0) circle(2.5);
      \begin{scope}[rotate=38]
        \draw[->] (0,0)--(2.45,0) node[midway,above]{\footnotesize$r$};
        \draw[fill=red!60] (2.5,0) circle(.1);
...
\begin{frame}{Angular Position and Angular Velocity}
  ...
  \begin{columns}
    ...
    $\theta$ is measured in \si{radians}, and $\omega$ in
...
\begin{frame}{Centripetal Acceleration \& Centripetal Force}
  ...
  \eq{-.15in}{
    \boxed{\bm a_c=-\frac{v^2}r\hat{\bm r}=-(\omega^2r)\hat{\bm r}}
  }
  ...
  \eq{-.15in}{
    \boxed{\bm F_c=m\bm a_c=-\frac{mv^2}r\hat{\bm r}}
  }
\end{frame}
