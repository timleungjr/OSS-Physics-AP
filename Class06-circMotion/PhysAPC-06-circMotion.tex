...
\begin{frame}{Angular Position and Angular Velocity}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=.75]
      ...
      \draw circle(2.5);
      \begin{scope}[rotate=38]
        \draw[vectors] (0,0)--(2.44,0) node[midway,above]{$r$};
        \draw[mass] (2.5,0) circle (.1);
      \end{scope}
    \end{tikzpicture}
...
\begin{frame}{Banked Curves on Highways and Racetracks}
  \begin{columns}
    ...
    \begin{tikzpicture}
      ...
      \draw[vectors,rotate=60] (0,0)--(0,-1)node[right]{$\vec f$};
    \end{tikzpicture}
    \begin{tikzpicture}
    ...
    \begin{tikzpicture}[scale=.75]
      ...
      \begin{scope}[rotate=45]
        ...
        \begin{scope}[vectors,red]
          ...
          \draw[dotted] (0,-5)--(0,-6.1) node[right]{$mg\cos\theta$};
      ...
      \draw[dashed] (0,0)--(0,-5);
      \draw[dashed] (3.54,-3.54) arc (315:225:5);
      \draw[->] (0,-2) arc(270:315:2) node[midway,below]{$\theta$};
    \end{tikzpicture}
...
\begin{frame}{Simple Pendulum: Bottom of Swing}
  ...
  \vspace{.1in}\begin{columns}
    ...
    \begin{tikzpicture}[scale=.8]
      ...
      \draw[vectors,red] (0,-5)--(0,-6.5) node[below]{$m\vec g$};
      \draw[dashed] (3.54,-3.54) arc(315:225:5);
    \end{tikzpicture}
    ...
    \item At the lowest point, tension is the highest:
      ...
      \eq{-.1in}{
        F_T=mg+F_c=m\left(g+\frac{v^2}r\right)
      }
    \end{itemize}
  \end{columns}
\end{frame}
