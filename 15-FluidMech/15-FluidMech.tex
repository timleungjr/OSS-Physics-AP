...
\begin{frame}
  ...
  \begin{columns}
    ...
    \vspace{-.45in}{\Large
      \begin{align*}
        p_2-p_1&=\rho_Ogz_1\\
        p_3-p_2&=\rho_Wg(z_2-z_1)\\
        p_4-p_3&=\rho_Gg(z_3-z_2)\\
        p_5-p_4&=\rho_Mg(z_4-z_3)\\\hline
        p_5-p_1&=\sum \Delta p
      \end{align*}
    }
  \end{columns}
...
\begin{frame}{Derivation of Buoyance Force}
...
\begin{frame}{An Easier Explanation of Buoyancy}
