...
\begin{frame}{Kinematic Equations For Constant Acceleration}
  ...
  kinematic equations\footnote{In Physics 11 and 12, depending on \emph{where}
    you learned these equation, they may be called the ``Big-five'' or
    ``Big-four'' equations. In AP, you will only be given $3$ equations
    in your equation sheet.} are still a very powerful tool.
  \begin{columns}
    \column{.45\textwidth}
