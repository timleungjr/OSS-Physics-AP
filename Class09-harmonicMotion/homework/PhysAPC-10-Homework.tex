...
\begin{multicols*}{2}
  \begin{questions}
    ...
    can be described as
    \begin{choices}
      \choice harmonic motion with a period of \SI3\second
...
\begin{questions}
  ...
  \begin{parts}
    ...
    \part On the graph below, plot the data points, and draw a straight line
  ...
  \cpic{.5}{oscillation1}
  \begin{parts}
    \part Determine the equation for $v(t)$, including numerical values for
    all constants.
    \vspace{\stretch1}
    ...
    \part Draw a sketch of $v$ versus $t$ in this case. Assume that there is a
