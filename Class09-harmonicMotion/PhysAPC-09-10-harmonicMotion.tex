...
\begin{frame}{Horizontal Spring-Mass System}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.1]
      ...
      \draw[vectors,red] (5.5,1)--(5.5,0) node[below]{$mg$};
      \draw[vectors,red] (5.5,1)--(5.5,2) node[above]{$N$};
      \draw[vectors,red] (5.5,1)--(4.5,1) node[above]{$F_s$};
    \end{tikzpicture}
  \end{center}
...
\begin{frame}{Horizontal Spring-Mass System}
  ...
  Cosine is \emph{usually} preferred over sine because $\cos(0)=1$, consistent
  with the fact that oscillations \emph{usually} begin at maximum amplitude $A$
  at $t=0$, and therefore $\phi=0$. Mathematically, the two functions only
  differ in $\phi$
\end{frame}
...
\begin{frame}{Displacement, Velocity and Acceleration}
  \begin{columns}
    ...
    \begin{tikzpicture}[yscale=.5]
      ...
      \draw[violet,veyr thick,smooth,samples=80,domain=0:7.5]
...
\begin{frame}{Vertical Spring-Mass System}
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=1.3]
      \draw[mass] (.75,1.75) rectangle (1.25,2.25);
      \draw[thick,decorate,
        decoration={aspect=.4,segment length=8,amplitude=8,coil}]
      (1,5)--(1,2.25); 
      \fill[pattern=north east lines] (0,5) rectangle (2,5.2);
      \draw[thick] (0,5)--(2,5);
      \draw[axes] (1.75,3)--(1.75,2) node[below]{$+$};
      \draw[vectors,red] (1,2)--(1,1) node[right]{$mg$};
      \draw[vectors,red] (1,2)--(1,3) node[right]{$F_s$};
    ...
    But since $mg$ is constant, the only change is the addition of a constant
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}
      ...
      \begin{scope}[rotate=15]
        ...
        \draw[vectors,red] (0,-5)--(0,-3) node[left]{$\vec T$};
        \draw[vectors,red,rotate around={-15:(0,-5)}] (0,-5)--(0,-6.5)
        node[below]{$m\vec g$};
      \end{scope}
      \draw[axes] (0,-2) arc(270:285:2) node[midway,below]{$\theta$};
      \draw[dashed] (0,0)--(0,-5);
...
\begin{frame}{It's Never Perfect}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \fill[gray,pattern=north east lines] (-.5,2)--(-.5,0)--(7,0)--(7,2)
      ...
      \uncover<2->{
        \draw[vectors,pink] (3.5,1)--(3.5,0) node[below]{$m\vec g$};
        \draw[vectors,pink] (3.5,1)--(3.5,2) node[above]{$\vec N$};
        \draw[vectors,pink] (3.5,1)--(2.5,1) node[above]{$\vec F_s$};
        \draw[vectors,red] (3.5,1)--(4.5,1) node[above]{$\vec F_D$};
        \fill[pink] (3.5,1) circle(.075);
      }
    \end{tikzpicture}
  \end{center}
  \uncover<3->{
...
\begin{frame}{Forced Harmonic Motion}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw[vectors,pink] (3.5,1)--(3.5,2) node[above]{$\vec N$};
      \draw[vectors,pink] (3.5,1)--(2.5,1) node[above]{$\vec F_s$};
      \draw[vectors,red] (3.5,.95)--(2,.95) node[below]{$\vec F_E$};
