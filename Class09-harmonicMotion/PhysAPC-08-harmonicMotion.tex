  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.1]
      ...
      \begin{scope}[very thick,->,red]
        ...
        \draw (5.5,1)--(4.5,1) node[above]{$\bm{F}_s$};
      \end{scope}
    \end{tikzpicture}
  \end{center}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        %\addlegendentry{$1-\left|\frac{\theta}{sin\theta}\right|$};
      \end{axis}
    \end{tikzpicture}
  \end{center}
...
\begin{frame}{Resonance}
  ...
  \item The frequency of the driving force is same as the natural frequency of
    ...
    \eq{-.2in}{
      \omega_E=\omega=\sqrt{\omega_0-\frac{b}{2m}}
...
\begin{frame}{Resonance}
  \begin{columns}
    ...
    that:
    \begin{itemize}
    \item Resonance response is highest when $\omega_E=\omega$, which we know
      already
