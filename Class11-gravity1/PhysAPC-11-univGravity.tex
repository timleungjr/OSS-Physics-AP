...
\begin{frame}{What If You Are Inside Another Mass?}{A Spherical Shell}
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=.45]
      ...
      \draw[fill=red](1,-1) circle(.2) node[below]{$m_2$};
    \end{tikzpicture}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=.45]
      \begin{scope}[thick]
        ...
        \draw[fill=black!2] circle(4.9);% node[above]{$m_1$};
...
\begin{frame}{Gravitational Field Inside a Spherical Shell}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw[very thick,red,samples=15,smooth,domain=1:5] plot(\x,{2/\x});
      \draw[very thick,red](0,0)--(1,0);
      \draw[very thick,red,fill=black!2](1,0) circle(.06);
...
\begin{frame}{Gravitational Field Lines}
  \begin{center}
    \begin{tikzpicture}[scale=1.5]
      ...
      \draw[fill=cyan!20,thick] circle(.15) node{$m$};
    \end{tikzpicture}
  \end{center}
  \begin{itemize}
