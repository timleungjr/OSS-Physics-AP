...
\item\textbf{(B)} This can be solved by a simple free body diagram of $M_2$:
  \begin{center}
    \begin{tikzpicture}
      \draw circle(.05);
      \draw[vectors] (0,0)--(0,1) node[above]{$T$};
      \draw[vectors] (0,0)--(0,-1) node[below]{$M_2g$};
      \draw[vectors] (1,.5)--(1,-.5) node[midway,right]{$a$};
    \end{tikzpicture}
  \end{center}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.9]
      ...
      \begin{scope}[rotate around = {atan(.75):(3,0)}]
        ...
        \draw[red!70!black,vectors,rotate around={-atan(.75):(3.1,2.5)}]
        (3.1,2.5)--(3.1,1) node[left]{$W$};
      \end{scope}
      \fill[red!70!black] (3,0) circle(.08);
      \draw[red!70!black,vectors] (3,0)--(3,1.5) node[right]{$N_1=W$};
      \draw[red!70!black,vectors] (3,0)--(2,0) node[below]{$f$};
      \fill[red!70!black] (0,4) circle(.08);
      \draw[red!70!black,vectors] (0,4)--(1,4) node[right]{$N_2=f$};
    \end{tikzpicture}
  \end{center}
