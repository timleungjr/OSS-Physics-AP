...
\begin{frame}
  ...
  \begin{columns}
    ...
    where
    \begin{itemize}
    \item $C$ is a close curve around a current
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{.7\textwidth}
    Another application of Amp\`{e}re's Law is the \textbf{toroid}.

    \vspace{.05in}This time, we put our loop at $a<r<b$ inside the toroid. Once
    again, because of symmetry, Amp\`{e}re's law reduces to:
