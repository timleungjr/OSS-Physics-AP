...
%    \end{enumerate}
  ...
  \item A satellite of mass m orbits the Earth with a potential energy $U$ and a
    kinetic energy $K$. Which of the following statements would have to be true
    for the satellite to escape the Earth's gravity completely?
    \begin{enumerate}[noitemsep,topsep=0pt,leftmargin=18pt,label=(\Alph*)]
...
\genfreetitle{C}{UNIVERSAL GRAVITATION}{5}
