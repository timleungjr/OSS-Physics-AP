...
\begin{multicols}{2}
  ...
  \item The centripetal acceleration on \SI{1000}{\kilo\gram} car in a turn is
    \SI{1e5}{\metre\per\second\squared}. The radius of the turn is
  ...
  \item A satellite orbits the Earth at a distance that is four times the radius
    ...
    \item zero
    \item $\displaystyle\frac{g}2$
    \item $\displaystyle\frac{g}4$
    \item $\displaystyle\frac{g}8$
    \item $\displaystyle\frac{g}{16}$
    \end{enumerate}
    \columnbreak
  ...
  \item Two masses exert a gravitational force $F$ on each other. If one of the
    ...
    \begin{enumerate}[itemsep=5pt,topsep=0pt,leftmargin=18pt,label=(\Alph*)]
    \item $6F$
    \item $\displaystyle\frac{2F}3$
    \item $\displaystyle\frac{2F}9$
    \item $\displaystyle\frac{3F}2$
    \item $\displaystyle\frac{4F}9$
    \end{enumerate}
    ...
    \begin{center}
      \begin{tikzpicture}[scale=0.8]
        ...
        \begin{scope}[rotate=50]
          ...
          \draw[thick,->](3,0.25)--(3,1.25) node[above]{$v$};
        \end{scope}
...
%    \end{enumerate}
  ...
  \item A satellite of mass $m$ travels in an elliptical orbit around a planet
    of mass $M$. The satellite has a speed $v$ when it is closest to the planet
    at a distance $r$. Work is done by the engines of the satellite to change
    its orbit to a circular orbit when it is at this distance $r$. Which of the
    following statements is true of the transition from an elliptical orbit to a
    circular orbit?
    \begin{enumerate}[nosep,leftmargin=18pt,label=(\Alph*)]
    \item The work done by the satellite engines to change the orbit is
      equal to the change in kinetic energy of the satellite.
    \item  The work done by the satellite engines to change the orbit is equal
      to the change in potential energy of the satellite.
    \item The work done by the satellite engines to change the orbit is equal
      to the change in angular momentum of the satellite.
    \item The work done by the satellite engines to change the orbit is
      equal to the change in speed of the satellite.
    \item The work done by the satellite engines to change the orbit is equal
      to the change in orbital radius of the satellite.
    \end{enumerate}
    \vspace{.7in}
    
  \item A satellite of mass $m$ orbits the Earth with a potential energy $U$
    and a kinetic energy $K$. Which of the following statements would have to
    be true for the satellite to escape the Earth's gravity completely?
    \begin{enumerate}[nosep,leftmargin=18pt,label=(\Alph*)]
    \item The kinetic energy of the satellite would have to be equal to the
      potential energy between the Earth and the satellite.
    \item The potential energy between the Earth and the satellite would have to
      be greater than the kinetic energy of the satellite.
    \item The total energy of the satellite would have to be greater than the
      kinetic energy of the satellite.
    \item The kinetic energy of the satellite would have to be greater than the
      potential energy of the satellite.
    \item The total energy of the satellite would have to be equal to the
      potential energy of the satellite.
    \end{enumerate}
  \end{enumerate}
\end{multicols}
...
\genfreetitle{C}{UNIVERSAL GRAVITATION}{6}
...
%      \draw[thick](2.5,0)--(2.5,-0.3) node[below]{O};
%      \draw[thick](4,0)--(4,-0.3) node[below]{A};
%    \end{tikzpicture}
%  \end{center} 
...
% QUESTION TAKEN FROM 2005 AP PHYSICS C QUESTION MECH 2
\item A student is given the set of orbital data for some of the moons of
  ...
  \def\arraystretch{1}
  \begin{enumerate}
  \item Write an algebraic expression for the gravitational force between
    Saturn and one of its moons.
  \item Use your expression from part (a) and the assumption of circular orbits
    to derive an equation for the orbital period $T$ of a moon as a function of
    its orbital radius $R$.
  \item Which quantities should be graphed to yield a straight line whose slope
    could be used to determine Saturn's mass?
  \item Complete the data table by calculating the two quantities to be
    graphed. Label the top of each column, including units.
  \item Plot the graph on the axes below. Label the axes with the variables
    used and appropriate numbers to indicate the scale.
    \cpic{.8}{graph-paper}
  \item Using the graph, calculate a value for the mass of Saturn.
  \end{enumerate}
  \newpage
