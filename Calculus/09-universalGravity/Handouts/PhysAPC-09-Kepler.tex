...
\begin{equation}
  L=mr^2\omega=mr^2\frac{d\theta}{dt}=\frac{m}{u^2}\frac{d\theta}{dt}
  \quad\longrightarrow\quad
  \frac{d\theta}{dt}=\frac{Lu^2}m
...
\begin{equation}
  \frac{dr}{dt} =\frac{d}{dt}\left(\frac1u\right)
  =-\frac1{u^2}\frac{du}{dt}=-\frac1{u^2}\frac{du}{d\theta}\frac{d\theta}{dt}
  = -\frac1{u^2}\frac{du}{d\theta} \frac{Lu^2}{m}
