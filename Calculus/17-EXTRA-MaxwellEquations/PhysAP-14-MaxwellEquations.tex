...
\begin{frame}{Maxwell's Modification to Amp\`{e}re's Law}
  ...
  \eq{-.1in}{
    \boxed{
      \oint\mb{B}\cdot d\boldsymbol{\ell}=\mu_0\left( I +
      \varepsilon_0 \frac{d\Phi_E}{dt}\right)
    }
  }
...
\begin{frame}{Electromagnetic (EM) Wave}
  ...
  \eq{-.2in}{
    ...
    \left(-\mu_0\varepsilon_0\frac{\partial E}{\partial t}\right)
  }
...
\begin{frame}{Electromagnetic (EM) Wave}
  ...
  that $\mb{E}$ and $\mb{B}$ are actually perpendicular to each other
\end{frame}
