...
\begin{frame}{First Law of Motion}
  ...
  \item Uniform motion means constant velocity; an object ``at rest'' is also
    in uniform motion with $\mb{v}=\mb{0}$
  ...
  \begin{columns}
    ...
    \begin{center}
      \begin{tikzpicture}[scale=.9]
        ...
        %\draw [->,very thick] (1.5,1)--(2.3,1) node[right]{$\mb{f}$};
        \end{scope}
      \end{tikzpicture}
    \end{center}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.3]
      \begin{scope}[rotate=-30]
	    ...
	    node[below]{$m\mb{g}$};
	    \draw[->,very thick](0,-1)--(0,.3)  node[above]{$\mb{N}$};
	    \draw[->,very thick](0,-1)--(-.5,-1) node[left]{$\mb{f}_s$};
