...
\begin{frame}{Position}
  \textbf{Position} ($\bm{x}$) describes the location of an object in a
  coordinate system. The origin of%\footnote{The coordinate system is usually
...
\begin{frame}{Instantaneous Velocity}
  Since position $\bm{x}$ is continuously differentiable in time $t$, the
  \textbf{instantaneous velocity} can be found at any time by differentiating
  $\bm{x}$ with respect to $t$. The unit for velocity is
  \textbf{meters per second} (\si{\metre\per\second}):

  
  \eq{-.2in}{
    \boxed{
      \bm{v}(t)= \frac{d\bm{x}}{dt}
    }
  }
  
  Since $\bm{x}$ has $x$, $y$ and $z$ components along the $\iii$, $\jjj$ and
  $\kkk$ directions that are linearly independent, we can take the time
  derivative in every component:
...
\begin{frame}{Integrating Velocity to Get Position/Displacement}
  Conversely, if instantaneous velocity $\bm{v}(t)$ is the time rate of change
  of position $\bm{x}(t)$, then $\bm{x}(t)$ is the time integral of $\bm{v}(t)$:
  ...
  $t=\num{0}$. We can integrate each component to get $\bm{x}$:

 \eq{-.2in}{ \bm{x}(t)= \left(
    \int u\iii + \int v\jjj + \int w\kkk \right) dt + \bm{x}_0
  }
\end{frame}
...
\begin{frame}{Average Velocity}
  ...
  \eq{-.3in}{
    \boxed{
      \overline{\bm{v}}=
      \frac{\Delta\bm{x}}{\Delta t}=
      \frac{\bm{x}-\bm{x}_0}{t-t_0}=
      \frac{\int_{t_0}^t\bm{v}dt}{t-t_0}
    }
  }
...
\begin{frame}{Instantaneous \& Average Speed}
  ...
  \begin{itemize}
  \item\vspace{-.1in}Since $s\geq 0$, instantaneous speed must also be
    positive, i.e.\ $v\geq 0$
  \item Instantaneous speed is also the magnitude of the instantaneous velocity
    vector, i.e.\ $v=|\bm{v}|$
  \end{itemize}
  ...
  \eq{-.2in}{
    \boxed{
      \overline{v}=\frac{s}{\Delta t}=\frac{\int_{t_0}^t vdt}{t-t_0}
    }
  }
...
\begin{frame}{Instantaneous \& Average Acceleration}
  ...
  \textbf{instantaneous acceleration} $\bm{a}(t)$ is the time rate of change in
  velocity, with a unit of \textbf{meters per second squared}
  (\si{\metre\per\second\squared}):

  \eq{-.25in}{
    \boxed{
      \bm{a}(t)= \frac{d\bm{v}}{dt}=\frac{d^2\bm{x}}{dt^2}
    }
  }

  Likewise, \textbf{average acceleration} $\overline{\bm{a}}$ is the finite
  change in velocity $\Delta\bm{v}$ over a finite time interval $\Delta t$:

  \eq{-.27in}{
    \boxed{
      \overline{\bm{a}}=
      \frac{\Delta\bm{v}}{\Delta t}
      =\frac{\bm{v}-\bm{v}_0}{t-t_0}
      =\frac{\int_{t_0}^t\bm{a}dt}{t-t_0}
    }
  }
...
\begin{frame}{Integrating Acceleration to Get Velocity}
  ...
  \eq{-.2in}{
    \bm{v}(t)=
    \left(\int a_x\iii + \int a_y\jjj + \int a_z\kkk \right) dt +\bm{v}_0
  }
\end{frame}
...
\begin{frame}{If You Are Curious}
  ...
  \eq{-.15in}{
    \bm{j}=\frac{d\bm{a}}{dt}=\frac{d^2\bm{v}}{dt^2}=\frac{d^3\bm{x}}{dt^3}
  }
  ...
  \eq{-.15in}{
    \bm{s}=\frac{d\bm{j}}{dt}=\frac{d^2\bm{a}}{dt^2}=\frac{d^3\bm{v}}{dt^3}
    =\frac{d^4\bm{x}}{dt^4}
  }
...
\begin{frame}{Acceleration as Functions of Velocity and Position}
  ...
  \item Aerodynamic drag:
    $\displaystyle a(v)=\left[\frac{\rho C_D A_\text{ref}}{2m}\right] v^2$
  \end{itemize}
