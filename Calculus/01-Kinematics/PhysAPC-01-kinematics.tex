...
\begin{frame}{Instantaneous Velocity}
  ...
  \eq{-.15in}{
    \bm{v}(t)= \diff{\bm{x}}t=
    \diff xt\iii + \diff yt\jjj + \diff zt\kkk = u\iii + v\jjj + w\kkk
  }
\end{frame}
...
\begin{frame}{Average Velocity}
  ...
  \eq{-.3in}{
    \boxed{
      ...
      \frac{\int_{t_0}^t\bm{v}\dl t}{t-t_0}
    }
  }
...
\begin{frame}{Instantaneous \& Average Speed}
  ...
  \eq{-.2in}{
    \boxed{
      \overline{v}=\frac{s}{\Delta t}=\frac{\int_{t_0}^t v\dl t}{t-t_0}
    }
  }
...
\begin{frame}{Instantaneous \& Average Acceleration}
  ...
  \eq{-.27in}{
    \boxed{
      ...
      =\frac{\int_{t_0}^t\bm{a}\dl t}{t-t_0}
    }
  }
...
\begin{frame}{If You Are Curious}
  ...
  \eq{-.15in}{
    \bm{j}=\diff{\bm{a}}t=\diff[2]{\bm{v}}t=\diff[3]{\bm{x}}t
  }
  ...
  \eq{-.15in}{
    \bm{s}=\diff{\bm{j}}t=\diff[2]{\bm{a}}t=\diff[3]{\bm{v}}t=\diff[4]{\bm{x}}t
  }
