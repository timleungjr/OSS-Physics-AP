...
\begin{frame}{Instantaneous Velocity}
  Since position $\mb{x}$ is differentiable in time $t$, then the
...
\begin{frame}{Relative Motion}
  \begin{columns}
    ...
    \vspace{-.1in}Differentiating all terms with respect with time, we get the
    ...
    \vspace{-.1in}Differentiating again, and we obtain the equation for
