...
\item A projectile is fired horizontally from a launching device, exiting with
  ...
  imparted to it is $J_p$, and the average force on it is $F_{avg}$. Assume the
  force becomes zero just as the projectile reaches the end of the launching
  device. Express your answers to parts (a) and (b) in terms of $v_x$, $J_p$,
  $F_{avg}$, and fundamental constants, as appropriate.
  \begin{enumerate}[leftmargin=18pt]
