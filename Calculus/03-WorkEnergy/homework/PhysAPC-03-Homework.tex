...
\begin{multicols}{2}
    ...
    \begin{center}
      \begin{tikzpicture}
        ...
        \begin{scope}[rotate=60]
          ...
          \draw[<->,thick](.5,0)--(.5,-4) node[midway,above right]{\tiny $l$};
        \end{scope}
        \draw[<->,thick](0,-1)arc(270:330:1)
        node[pos=.6,below]{\footnotesize\ang{60}};
      \end{tikzpicture}
    \end{center}
    \begin{enumerate}[nosep,leftmargin=18pt,label=(\Alph*)]
  ...
  \begin{center}
    \begin{tikzpicture}
      \fill[gray!70](0,-.15) rectangle(5,0);
      \draw[thick](0,0)--(5,0);
...
\item A \SI{2.}{\kilo\gram} block is released \SI{4.}{\metre} from a massless
