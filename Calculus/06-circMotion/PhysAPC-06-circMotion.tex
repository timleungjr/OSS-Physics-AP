...
\begin{frame}{Centripetal Acceleration \& Centripetal Force}
  ...
  \eq{-.15in}{
    \boxed{\mb{a}_r=-\frac{v^2}{r}\hat{\mb{r}}=-\omega^2r\hat{\mb{r}}}
  }

  (The negative sign is because $\hat{\mb{r}}$ is radially outward from the
...
\begin{frame}{Acceleration: The General Case}
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=4.3]
      ...
      node[pos=0.5,below]{\footnotesize $a_r=\omega^2r$};
