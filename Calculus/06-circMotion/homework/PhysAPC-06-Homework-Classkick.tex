...
%    \columnbreak
    ...
    The speed of the ball at the bottom of the circle is $\varv$. The tension
    ...
    To maintain a constant speed $\varv$ on the track, the coefficient of
...
%    \end{choices}
    ...
    eperiences no change in altitude during the turn? Assume that the wings
    ...
    \uplevel{
      \textbf{Questions \ref{conical1}--\ref{conical2}}
        
      A conical pendulum consists of a ball attached to a string that
      moves in a horizontal circle, as shown below.
      \begin{center}
        \begin{tikzpicture}[scale=.8]
          \draw[thick,dashed](0,0) ellipse(3 and .7);
...
%      \end{tikzpicture}
    ...
    \SI{200}{\metre} and is banked at \ang{31} above the horizontal. Assume that
    a race car has a mass of \SI{1500}{\kilo\gram} and that the coefficient of
    friction between the car's tires and the track is 0.90. What is the maximum
    speed at which a race car can travel through the curve and not slide toward
...
\genfreetitle{C}{CIRCULAR MOTION}{3}
