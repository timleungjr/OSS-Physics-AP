...
\begin{frame}{Mass on a Spring}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.1]
      ...
      \draw[ultra thick,->,red](a)--(5.5,0) node[right]{$m\mb{g}$};
      \draw[ultra thick,->,red](a)--(5.5,2) node[right]{$\mb{N}$};
      \draw[ultra thick,->,red](a)--(4.5,1) node[above]{$\mb{F}_s$};
      \draw[->,thick](7,1)--(7.8,1) node[right]{$x$};
    \end{tikzpicture}
  \end{center}
  $m\mb{g}$ and $\mb{N}$ cancel out, so net force is due only to spring force
...
\begin{frame}{Vertical Spring-Mass System}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=1.3]
      ...
      \draw[very thick,->,red](1,2)--(1,1) node[below]{$m\mb{g}$};
      \draw[very thick,->,red](1,2)--(1,3) node[right]{$\mb{F}_s$};
    \end{tikzpicture}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[scale=1.1]
      ...
      \uncover<3->{
        ...
        \draw[ultra thick,->,red](3.5,1)--(3.5,0) node[below]{$m\mb{g}$};
        \draw[ultra thick,->,red](3.5,1)--(3.5,2) node[above]{$\mb{N}$};
        \draw[ultra thick,->,red](3.5,1)--(2.5,1) node[above]{$\mb{F}_s$};
        \draw[ultra thick,->,red](3.5,1)--(4.5,1) node[below]{$\mb{F}_D$};
      }
    \end{tikzpicture}
  \end{center}
  \uncover<4->{
...
%      \fill[red] (3.5,1)circle(.075);
%      \draw[ultra thick,->,red](3.5,1)--(3.5,0) node[below]{$\mb{F}_g$};
%      \draw[ultra thick,->,red](3.5,1)--(3.5,2) node[above]{$\mb{F}_N$};
%      \draw[ultra thick,->,red](3.5,1)--(2.5,1) node[above]{$\mb{F}_s$};
%      \draw[ultra thick,->,red](3.5,1)--(4.5,1) node[below]{$\mb{F}_D$};
%    \end{tikzpicture}
%  \end{center}
...
\begin{frame}{Forced Harmonic Motion}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw[ultra thick,->,red](3.5,1)--(3.5,2) node[above]{$\mb{N}$};
      \draw[ultra thick,->,red](3.5,1)--(2.5,1) node[above]{$\mb{F}_s$};
      \draw[ultra thick,->,red](3.5,.9)--(2,.9) node[below]{$\mb{F}_{ext}$};
      \draw[ultra thick,->,red](3.5,1)--(4.5,1) node[below]{$\mb{F}_D$};
    \end{tikzpicture}
  \end{center}
\end{frame}
