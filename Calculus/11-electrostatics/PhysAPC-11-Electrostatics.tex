...
\begin{frame}{Think Electric Field}
  $\bm{E}$ iself \emph{doesn't do anything} until another charge interacts with
...
%  \vspace{-.1in}$\bm{F}_q$ and $\bm{E}$ are vectors, and following the
%  principle of superposition, i.e.
%
%  \vspace{-.45in}{\Large
%    \begin{align*}
%      \bm{F}_q&=\bm{F}_1+\bm{F}_2+\bm{F}_3+\bm{F}_4\ldots\\
%      \bm{E}&=\bm{E}_1+\bm{E}_2+\bm{E}_3+\bm{E}_4\ldots
%    \end{align*}
%  }
%  
%  \vspace{-.3in}This understanding is especially important when we want to find
%  $\bm{F}_q$ and $\bm{E}$ some distance from a continuous distribution of
%  charges
\end{frame}
...
\begin{frame}{Electric Flux and Gauss's Law}
  ...
  \eq{-.2in}{
    \boxed{
      \Phi_q=\oint\bm{E}\cdot\dl\bm{A}=\frac{Q_{encl}}{\epsilon_0}
    }
  }
