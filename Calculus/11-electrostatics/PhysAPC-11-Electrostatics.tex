...
\begin{frame}{More Than One Charge}
  ...
  \eq{-.2in}{
    \boxed{
      \mb{E}=\int d\mb{E}=E\int\frac{dq}{r^2}\hat{\mb{r}}
    }
  }
...
\begin{frame}{Electric Flux and Gauss's Law}
  ...
  \eq{-.2in}{
    \boxed{
      \Phi_q=\oint\mb{E}\cdot d\mb{A}=\frac{Q_{encl}}{\epsilon_0}
    }
  }
    
  where
  \begin{itemize}
  \item $Q_{encl}$ is the charge enclosed by the surface
...
\begin{frame}{Electric Field Near an Infinite Plane of Charge}
  \begin{columns}
    ...
    \item The enclosed charge is $Q_{encl}=\sigma A$
    \end{itemize}
  \end{columns}
\end{frame}
...
\begin{frame}{Electric Field Near an Infinite Plane of Charge}
  \begin{columns}
    ...
    \eq{-.2in}{
      \oint\mb{E}\cdot d\mb{A}=\frac{Q_{encl}}{\epsilon_0}
      \;\rightarrow\;
