...
\begin{frame}{Laws of Motion \& Conservation of Momentum}
  ...
  \eq{-.2in}{
    \boxed{\mb{F}_{net}=\frac{d\mb{p}}{dt}}
  }
...
\begin{frame}{Impulse}
  ...
  \eq{-.15in}{
    \mb{F}_{net}=\frac{d\mb{p}}{dt}\;\rightarrow\;
    \mb{F}_{net}dt=d\mb{p}
  }
  ...
  \eq{-.15in}{
    \boxed{
      \mb{J}_{net}
      =\int_{t_1}^{t_2}\mb{F}_{net}dt
      =\int_{p_1}^{p_2} d\mb{p}=\Delta\mb{p}}
  }
  
  The quantity $\mb{J}_{net}$ is called the \textbf{net impulse}.
\end{frame}
