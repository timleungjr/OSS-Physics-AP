...
\begin{frame}{General Form of Second Law of Motion}
  ...
  \eq{-.15in}{
    \frac{d\bm{p}}{dt}=\frac{d(m\bm{v})}{dt}
    =m\frac{d\bm{v}}{dt}+\frac{dm}{dt}\bm{v}
    =m\bm{a}+\dot{m}\bm{v}
  }
...
\begin{frame}{Laws of Motion \& Conservation of Momentum}
  ...
  \eq{-.2in}{
    \boxed{\bm{F}_{net}=\frac{d\bm{p}}{dt}}
  }
...
\begin{frame}{Impulse}
  ...
  \eq{-.15in}{
    \bm{F}_{net}=\frac{d\bm{p}}{dt}\;\rightarrow\;
    \bm{F}_{net}dt=d\bm{p}
  }
  ...
  \eq{-.15in}{
    \boxed{
      \bm{J}_{net}
      =\int_{t_1}^{t_2}\bm{F}_{net}dt
      =\int_{p_1}^{p_2} d\bm{p}=\Delta\bm{p}}
  }
...
%  \eq{-.15in}{
%    \overline{\bm{F}}=\frac{\int_{t_1}^{t_2}\bm{F}dt}{t_2-t_1}
%    =\frac{\bm{J}}{\Delta t}
%  }
  \eq{-.15in}{
    \bm{J}=\int_{t_1}^{t_2}\bm{F}dt=\overline{\bm{F}}\Delta t
  }
\end{frame}
