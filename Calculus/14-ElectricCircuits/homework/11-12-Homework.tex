...
\genfreetitle{C}{CIRCUIT ANALYSIS}{4}
...
\item A student sets up the circuit above in the lab. The values of the
  ...
  \end{center}
  \begin{enumerate}[leftmargin=15pt]
  \item Using the data above, calculate the battery voltage e .
...
\item In the circuit above, an ideal battery of voltage $V_0$ is connected to a
  ...
  \item The switch is closed at time $t=0$. On the axes below, sketch the
    ...
    \begin{center}
      \begin{tikzpicture}[scale=.65]
        \draw[dashed,->](0,0)--(10,0) node[pos=1,right]{$t$};
        \draw[dashed,->](0,0)--(0,5)  node[pos=1,above]{$q$};
      \end{tikzpicture}
    \end{center}
  \item On the axes below, sketch the current $I$ through each resistor as a
    ...
    \begin{center}
      \begin{tikzpicture}[scale=.65]
        \draw[dashed,->](0,0)--(10,0) node[pos=1,right]{$t$};
        \draw[dashed,->](0,0)--(0,5)  node[pos=1,above]{$I$};
      \end{tikzpicture}
    \end{center}
  \end{enumerate}
  The circuit is constructed using an ideal 1.5 V battery, an
