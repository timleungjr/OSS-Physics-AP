...
%    \end{enumerate}
  ...
  \item Three charges, $+Q$, $-Q$, and $+2Q$, are arranged in an equilateral
    ...
    \item {\LARGE $\displaystyle\downarrow$}
    \item {\LARGE $\displaystyle\uparrow$}
    \item {\LARGE $\displaystyle\searrow$}
    \item {\LARGE $\displaystyle\swarrow$}
    \item {\LARGE $\displaystyle\nearrow$}
    \end{enumerate}
...
\item Two point charges, $q_1$ and $q_2$, are fixed in place on the $x$-axis at
  ...
  \begin{center}
    ...
    \end{tikzpicture}
  \end{center}
\item A spherical cloud of charge of radius $R$ contains a total charge $+Q$
  with a nonuniform volume charge density that varies according to the equation
  \begin{align*}
  ...
  \begin{enumerate}
  \item Determine the following as a function of $r$ for $r>R$.
    \begin{enumerate}
    \item The magnitude $E$ of the electric field
    \item The electric potential $V$
    \end{enumerate}
  \item A proton is placed at point $P$ shown above and released. Describe its
    motion for a long time after its release.
  \item An electron of charge magnitude $e$ is now placed at point $P$, which
    ...
    cloud.
  \item Derive an expression for $\rho_0$.
  \item Determine the magnitude $E$ of the electric field as a function of $r$
    for $r\leq R$.
  \end{enumerate}
  \newpage
...
\item The figure above left shows a hollow, infinite, cylindrical, uncharged
  conducting shell of inner radius $r_1$ and outer radius $r_2$. An infinite
  line charge of linear charge density $+\lambda$ is parallel to its axis but
  off center. An enlarged cross section of the cylindrical shell is shown above
  right.
  \begin{enumerate}
  \item  On the cross section above right,
    \begin{enumerate}
    \item sketch the electric field lines, if any, in each of regions I, II,
      and III and
    \item use $+$ and $-$ signs to indicate any charge induced on the conductor.
      \end{enumerate}
  \item In the spaces below, rank the electric potentials at points $a$, $b$,
  ...
  \cpic{.65}{concentric}
  \begin{enumerate}[resume]
  \item The shell is replaced by another cylindrical shell that has the same
    ...
    \begin{enumerate}
    \item $r < r_1$
    \item $r_1\leq r\leq r_2$
    \item $r > r_2$
    \end{enumerate}
  \end{enumerate}
  \newpage
    
\item A spherically symmetric charge distribution has net positive charge $Q_0$
  distributed within a radius of $R$. Its electric potential $V$ as a function
  of the distance $r$ from the center of the sphere is given by the following
  \begin{align*}
  ...
  \begin{enumerate}
  \item For the following regions, indicate the direction of the electric field
    $E(r)$ and derive an expression for its magnitude.
    \begin{enumerate}
    \item $r < R$
    ...
    \item $r > R$
      ...
      \vspace{.1in}\underline{\hspace{.4in}} Radially outward
    \end{enumerate}
  \item For the following regions, derive an expression for the enclosed charge
    that generates the electric field in that region, expressed as a function
    of $r$.
    \begin{enumerate}
    \item $r < R$
    \item $r > R$
    \end{enumerate}
  \item Is there any charge on the surface of the sphere ($r=R$)?

    \vspace{.1in}\underline{\hspace{.4in}} Yes\hspace{.3in}
    \underline{\hspace{.4in}} No
    
    If there is, determine the charge. In either case, explain your reasoning.
  \item On the axes below, sketch a graph of the force that would act on a
