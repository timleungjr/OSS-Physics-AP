...
\begin{frame}{Mechanical Work}
  ...
  \eq{-.2in}{
    W_t=\int_{x_1}^{x_2}\bm{F}\cdot \dl\bm{x}
  }
  ...
  \eq{-.2in}{
    \boxed{
      W_r=\int_{\theta_1}^{\theta_2}\bm\tau\cdot \dl\bm\theta
    }
  }
...
\begin{frame}{Rotational Kinetic Energy}
  ...
  \eq{-.1in}{
    K_r=\sum_i\frac12m_iv_i^2=\sum\frac12m_i(r_i\omega)^2=\frac12\left(\sum_i m_ir_i^2\right)\omega^2
  }
