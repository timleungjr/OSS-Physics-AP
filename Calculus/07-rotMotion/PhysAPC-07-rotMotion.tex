...
\begin{frame}{Torque}
  ...
  \begin{center}
    ...
    \end{tikzpicture}
  \end{center}
  $\mb{F}_{net}=\mb{0}$, therefore $\mb{a}=\mb{0}$. But (obviously) it
...
\begin{frame}{Angular Momentum}
  ...
  \begin{columns}
    ...
    \vspace{-.15in}The direction of $\mb{L}$ depends on the direction of
    ...
    \begin{tikzpicture}[scale=2.5]
      \begin{scope}[rotate=70]
        ...
        \draw[ultra thick,->](2,0)--(2,.5)node[above]{$\mb{v}$};
      \end{scope}
    \end{tikzpicture}
  \end{columns}
\end{frame}
