...
\begin{questions}
  ...
  \SI{.080}\metre, uniform cross-sectional area \SI{5.0e-6}{\metre\squared},
  ...
  \begin{parts}
    ...
    \part
    \begin{subparts}
      \subpart Determine an expression for the current through bulb 2.
      \subpart Indicate on the diagram above the direction of the current
      through bulb 2.
    \end{subparts}
  ...
  \begin{parts}
    \part Indicate the direction of the current induced in the circuit. Justify
    your answer.
    ...
    of the rod increases, decreases, or remains the same. Justify your answer.
