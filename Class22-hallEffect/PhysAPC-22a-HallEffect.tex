...
\begin{frame}{Hall Effect}
  When a current $I$ flows through a conductor in a magnetic field $\vec B$,
  the magnetic field exerts a transverse (i.e.\ perpendicular to motion)
  magnetic force $\vec F_m$ on the moving charges which pushes them toward one
