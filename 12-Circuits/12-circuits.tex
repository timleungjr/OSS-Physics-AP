  ...
  \begin{center}
    \fbox{
      \begin{minipage}{.6\textwidth}
        ...
        There will be a supply teacher for next week. Please be kind! Tim will
        return to Olympiads on Sunday, February 18,, and will resume teaching
        this class on the 24th (class 14).
      \end{minipage}
    }
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  $Q_\mathrm{tot}$ stored across all the capacitors of capacitance and this
  common voltage $V$: 
...
\begin{frame}
  ...
  \vspace{-.1in}the constant of integration $K$ is related to initial charge on
  the capacitor $Q_\mathrm{tot}$:
