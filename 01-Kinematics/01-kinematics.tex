...
\begin{frame}{Integrating Velocity to Get Position/Displacement}
  ...
  $\mb{x}$ w.r.t.\ time $t$, then $\mb{x}$ is the time integral of
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \vspace{-.3in}{\Large
      \begin{align*}
        \Delta\mb{x} &=\mb{v}_1t + \frac{1}{2}\mb{a}t^2\\
        \Delta\mb{x} &=\mb{v}_2t - \frac{1}{2}\mb{a}t^2\\
        \Delta\mb{x} &=\frac{\mb{v}_1+\mb{v}_2}{2}t\\
        \mb{v}_2 &=\mb{v}_1+\mb{a}t\\
    ...
    \item The variables of interests are:
      ...
      \eq{-.3in}{
        \Delta\mb{x}\quad\mb{v}_1\quad\mb{v}_2\quad t\quad\mb{a}
      }
