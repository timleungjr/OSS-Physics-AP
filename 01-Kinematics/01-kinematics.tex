...
\begin{frame}{Partial Derivatives}
  ...
  Differentiating w.r.t.\ one variable while holding other variables
...
\begin{frame}{Common Integrals in Physics}
  Integration can be very daunting (even though it's often necessary), but the
  integrals in AP Physics are relatively straightforward. These examples should
  help in most cases:
