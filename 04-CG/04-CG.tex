  ...
  \item We start with a very simple example: there are two equal masses along
    ...
    \begin{center}
      \begin{tikzpicture}
        ...
        \draw[fill=gray!50] (-2.5,0) circle(0.3) node{$m$};
        \draw[fill=gray!50] (2.5,0) circle(0.3)  node{$m$};
        \uncover<2->{
          \draw[fill=black] (0,0) circle(0.05) node[below]{CM};
        }
      \end{tikzpicture}
    \end{center}
    \vspace{0.2in}
  ...
  \item This is still not a terribly difficult problem; you can still
    ...
    \begin{center}
      \begin{tikzpicture}
        \draw[->] (-4,0)--(4,0) node[pos=1,right]{$x$};
        \draw[fill=gray!50] (-2.5,0) circle(0.3) node{$m$};
        \draw[fill=gray!50] (2.5,0) circle(0.42)  node{$2m$};
        \uncover<2->{
          \draw[fill=black] (0.833,0) circle(0.05) node[below]{CM};
        }
      \end{tikzpicture}
    \end{center}
    \vspace{0.15in}
...
\begin{frame}
  ...
  \item If we increase the number of point masses along the $x$-axis, our
    ...
    \begin{center}
      \begin{tikzpicture}
        \draw[->] (-4,0)--(4,0) node[pos=1,right]{$x$};
        \draw[fill=gray!50] (-3.2,0) circle(0.4);
        \draw[fill=gray!50] (-2.5,0) circle(0.1);
        \draw[fill=gray!50] (1.5,0) circle(0.15);
        \draw[fill=gray!50] (0  ,0) circle(0.3);
        \draw[fill=gray!50] (2.5,0) circle(0.25);
      \end{tikzpicture}
    \end{center}
  ...
  \item Difficulties really arises when there are many masses in the system in
    ...
    \begin{center}
      \begin{tikzpicture}
        ...
        \draw[fill=gray!50] (-1.3,1) circle(0.4);
        \draw[fill=gray!50] (-1.5,-0.5) circle(0.1);
        \draw[fill=gray!50] (1,0.3) circle(0.15);
        \draw[fill=gray!50] (0,.3) circle(0.2);
        \draw[fill=gray!50] (2,-1) circle(0.25);
      \end{tikzpicture}
    \end{center}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item We can deal with each component individually. For example, in the
    $y$-direction:

    \vspace{-.2in}{\large
      \begin{displaymath}
        y_\mathrm{CM}=\frac{\sum y_i m_i}{\sum m_i}
    \end{displaymath}
    }
    
    where $y_\mathrm{CM}$ is the $y$-coordinate of the CM, and $y_i$ are the
    $y$-coordinates of the individual point masses
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{align*}
    m_1&=\SI{5.0}{\kg} &\mb{x}_1&=3\hat{\bm{\imath}}-2\hat{\bm{k}}\\
    m_2&=\SI{10.0}{\kg}&\mb{x}_2&=-4\hat{\bm{\imath}}+2\hat{\bm{\jmath}}+7\hat{\bm{k}}\\
    m_3&=\SI{1.0}{\kg}&\mb{x}_3&=10\hat{\bm{\imath}}-17\hat{\bm{\jmath}}+10\hat{\bm{k}}
  \end{align*}
  What are the coordinates for the center of mass of this system?
\end{frame}
\begin{frame}
  \frametitle{Continuous Mass Distribution}
  Most real-life masses are not a discrete collection of point masses, so for
  continuous mass distributions, we take the limit of when the number of
  masses approaches $\infty$:
  ...
  This, in fact, gives us an integral version of our equation:
  ...
  \begin{minipage}{0.4\textwidth}
    \begin{center}
      \begin{tikzpicture}[scale=0.8]
        ...
        \uncover<2->{
          \draw[fill=red](1,0)--(1.2,0)--(1.2,2.4)--(1.0,2.67)
  ...
  \begin{minipage}{0.4\textwidth}
    \begin{center}
      \begin{tikzpicture}[scale=3]
        ...
        plot[smooth,samples=50,domain=1:0] (\x,{\x^(0.5)});
        
        \draw[red!70,thick] plot[smooth,samples=50,domain=0:1] (\x,{\x*\x*\x});
        \draw[blue!70,thick] plot[smooth,samples=50,domain=0:1] (\x,{\x^(0.5)});
        \node at (0.4,0.85){\textcolor{blue!70}{\footnotesize $y=\sqrt{x}$}};
        \node at (0.9,0.3){\textcolor{red!70}{\footnotesize $y=x^3$}};
      \end{tikzpicture}
    \end{center}
  \end{minipage}
\end{frame}
  ...
  \item\textbf{Example:} What is the center of mass of this shape?
    ...
    \begin{center}
      \begin{tikzpicture}
        ...
        \draw[fill=black](0,1) circle(0.04);
        \draw[thick,->](0,1)--(0.707,.293) node[pos=1,right]{\footnotesize$r/2$};
      \end{tikzpicture}
    \end{center}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
  \item We can take the time derivative of the equation for $\mb{x}_\mathrm{CM}$
    to get a (very similar) expression for the velocity of the CM:
  ...
  \item The integral in the numerator is the sum of the momentum of all the
    masses in the system ($\mb{p}_\mathrm{net}$) which means that we have
  ...
  \item Taking the derivative of $\mb{p}_\mathrm{net}$ allows us to relate force
