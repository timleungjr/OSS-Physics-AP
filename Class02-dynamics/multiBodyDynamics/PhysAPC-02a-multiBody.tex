...
\begin{center}
  ...
  \end{tikzpicture}
\end{center}
Three masses are pushed forward by an external force $\mathbf F$ over a frictionless
surface. What is the acceleration of the masses?
\newpage
...
\begin{center}
  ...
  \end{tikzpicture}
\end{center}
Masses $m_1$ and $m_2$ are pulled forward by a external force $\mathbf F$ without
slipping.
\begin{enumerate}[nosep]
...
\begin{center}
  ...
  \end{tikzpicture}
\end{center}
Two masses ($M>m$) are connected by a massless string over a massless and frictionless
pulley. What is the magnitude of acceleration of the masses?
\newpage
