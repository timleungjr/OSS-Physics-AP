...
\begin{multicols*}{2}
  ...
  Two blocks, \SI4{\kilo\gram} and \SI2{\kilo\gram}, are connected by a string.
  An applied force $F$ of magnitude \SI{18}{\newton} pulls the blocks to the
  left.
  \begin{center}
  ...
  \begin{questions}
    ...
    \fullwidth{
      ...
      A system consists of two blocks having masses of \SI2{\kilo\gram} and
      \SI1{\kilo\gram}. The blocks are connected by a string of negligible
...
%    \label{plane2}
    ...
    \fullwidth{
      ...
      A block of mass \SI2{\kilo\gram} rests on top of a larger block of mass
      \SI4{\kilo\gram}. The larger block slides without friction on a table,
