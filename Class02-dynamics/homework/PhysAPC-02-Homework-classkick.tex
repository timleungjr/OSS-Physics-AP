...
\begin{multicols*}{2}
  ...
  \question The acceleration of the \SI2{\kilo\gram} block is most nearly
    ...
    \begin{choices}
<<<<<<< HEAD:Calculus/02-Dynamics/homework/PhysAPC-02-Homework-classkick.tex
...
=======
      ...
      \choice $\sqrt{\dfrac{gD}2}$
      \choice $\sqrt{\dfrac{4gD}6}$
>>>>>>> ca6e305ad4df399e2a9ef8a235f5fe570640d2e8:Class02-dynamics/homework/PhysAPC-02-Homework-classkick.tex
    \end{choices}
    \label{q:pulley2}
