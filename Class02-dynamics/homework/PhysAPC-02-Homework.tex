...
>>>>>>> 2022-09-fall
  ...
  \begin{questions}
    ...
    \uplevel{
      ...
      The position of a \SI2{\kilo\gram} object is described by the equation
...
<<<<<<< HEAD
      \begin{scope}[very thick]
        ...
        \draw[->](.2,1.3)--(1.6,1.3) node[midway,above]{$\varv$};
      \end{scope}
=======
      \draw(-1.5,0)--(5.5,0);
      \draw rectangle(1.8,1) node[midway]{$m$};
...
<<<<<<< HEAD
    to determine the speed $\varv$ of the box as a function of time $t$. If you
=======
...
<<<<<<< HEAD
    for the speed $\varv$ of the box as a function of time $t$. Assume that
    $\varv=0$ at time $t=0$.
    \vspace{\stretch1}
    \newpage
    
    \part On the axes below, sketch a graph of the speed $\varv$ of the box as
    a function of time $t$. Explicitly label any intercepts, asymptotes, maxima,
    or minima with numerical values or algebraic expressions, as appropriate.
    \begin{center}
      \begin{tikzpicture}
<<<<<<< HEAD
        \draw[very thick,->](0,0)--(4,0) node[pos=0,left]{$O$} node[right]{$t$};
...
<<<<<<< HEAD
      by a braking force $-k\vec\varv$, where $k$ is a constant and $\vec\varv$
      is the velocity of the compartment. Express all algebraic answers to the
