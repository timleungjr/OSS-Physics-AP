  ...
  \begin{center}
    \fbox{
      \begin{minipage}{.7\textwidth}
        \textbf{Law \#1: Every object will remain in its state of rest or
...
\begin{frame}{There is No Absolute Rest}
  \begin{center}
    \fbox{\textbf{Absolute rest cannot be determined}}
  \end{center}
  \begin{columns}
    \column{.35\textwidth}
    \pic{1.1}{coffeecup}
...
\begin{frame}{There is No Absolute Rest}
  \begin{center}
    \fbox{\textbf{Uniform motion is indistinguishable from rest}}
  \end{center}
  \begin{columns}
    \column{.25\textwidth}
...
\begin{frame}{Normal Force}
  \begin{columns}
    ...
    \begin{tikzpicture}
      ...
      \draw[vectors] (.75,.5)--(.75,-.5) node[below]{$m\vec g$};
      \draw[vectors] (.75,.5)--(.75,1.5) node[above]{$\vec N$};
    \end{tikzpicture}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.9]
      ...
      \begin{scope}[rotate=30]
        ...
        (3,.75)--(3,-1) node[right]{$m\vec g$};
        \draw[vectors,red] (3,.75)--(3,2.25) node[left]{$\vec N$};
        \fill (3,.75) circle (.06);
      \end{scope}
    \end{tikzpicture}
  \end{center}
...
\begin{frame}{Terminal Velocity}
  ...
  \begin{columns}
    ...
    \begin{center}
      \begin{tikzpicture}[scale=.9]
        \draw[vectors] (0,0)--(0,-1.5) node[below]{$m\vec g$};
        \draw[vectors,black!2] (0,0)--(0,1.5) node[above]{$\vec D$};
        \fill circle (.07);
      \end{tikzpicture}
    \end{center}
    ...
    \begin{center}
      \begin{tikzpicture}[scale=.9]
        \draw[vectors] (0,0)--(0,-1.5) node[below]{$m\vec g$};
        \draw[vectors,black!2] (0,0)--(0,1.5) node[above]{$\vec D$};
        \draw[vectors,green] (0,0)--(0,.6) node[above]{$\vec D$};
        \fill circle (.07);
      \end{tikzpicture}
    \end{center}
    ...
    \begin{center}
      \begin{tikzpicture}[scale=.9]
        \draw[vectors] (0,0)--(0,-1.5) node[below]{$m\vec g$};
        \draw[vectors,red] (0,0)--(0,1.5) node[above]{$\vec D$};
        \fill circle (.07);
      \end{tikzpicture}
    \end{center}
...
\begin{frame}{Free-Body Diagrams}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.8]
      \fill (1.5,1) circle(.1);
      \draw[vectors] (1.5,1)--(1.5,-.5) node[below]{$m\vec g$};
      \draw[vectors] (1.5,1)--(1.5,2.5) node[above]{$\vec N$};
...
\begin{frame}{Free-Body Diagrams}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.1,rotate=-30]
      ...
      \draw[thick] (-2,-1)--(2,-1);
      \fill circle(.05);
      \draw[vectors,rotate=30] (0,0)--(0,-1.5) node[below]{$m\vec g$};
      \draw[vectors] (0,-1)--(0,.3) node[above]{$\vec N$};
