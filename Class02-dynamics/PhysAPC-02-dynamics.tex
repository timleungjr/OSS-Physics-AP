...
\begin{frame}{Normal Force}
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=1.5]
      ...
      \draw[fill=cyan!50,thick] rectangle (1.5,1);
...
\begin{frame}{Normal Force on a Slope}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.9]
      \draw[thick] (0,0)--(5,0);
      \draw[->,thick] (1.7,0) arc (0:30:1.7) node[pos=.6,right] {$\theta$};
      \begin{scope}[rotate=30]
        \draw[thick] (0,0)--(5,0);
        \draw[fill=cyan!50,thick] (2,0) rectangle (4,1.5);
        \draw [->,very thick,rotate around={-30:(3,.75)}]
        (3,.75)--(3,-1) node[right]{$m\vec g$};
        \draw [->,very thick,red] (3,.75)--(3,2.25) node[left]{$\vec N$};
        \fill(3,.75) circle(.06);
      \end{scope}
    \end{tikzpicture}
  \end{center}
...
<<<<<<< HEAD
<<<<<<< HEAD
      \draw[ultra thick,->,gray!30](3,.3)--(5,.3)node[midway,below]{$x$};
