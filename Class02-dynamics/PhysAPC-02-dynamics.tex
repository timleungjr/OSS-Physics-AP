...
\begin{frame}{Second Law of Motion}
  ...
  \item The first two laws of motion can be summarized in the equation:
    ...
    \eq{-.2in}{
      \boxed{\bm F_\text{net}=\Sigma\bm F=m\bm a}
    }
...
\begin{frame}{Third Law of Motion}
  \begin{center}
    \fbox{
<<<<<<< HEAD:Calculus/02-Dynamics/PhysAPC-02-dynamics.tex
...
>>>>>>> ca6e305ad4df399e2a9ef8a235f5fe570640d2e8:Class02-dynamics/PhysAPC-02-dynamics.tex
      \end{minipage}
    }
  \end{center}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}
      ...
      \begin{scope}[->,very thick]
        \draw(.75,.5)--(.75,-.5) node[below]{$m\bm g$};
        \draw(.75,.5)--(.75,1.5) node[above]{$\bm N$};
        \draw(.75,.5)--(2.,.5)   node[right]{$\bm F_a$};
        \draw(.75,.5)--(.1,.5)   node[left] {$\bm f$};
      \end{scope}
    \end{tikzpicture}
...
\begin{frame}{Free-Body Diagrams}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.8]
      \fill(1.5,1) circle(.1);
      \begin{scope}[->,very thick]
        \draw(1.5,1)--(1.5,-.5) node[below]{$m\bm g$};
        \draw(1.5,1)--(1.5,2.5) node[above]{$\bm N$};
        \draw(1.5,1)--(3.1,1)   node[right]{$\bm F_a$};
        \draw(1.5,1)--(.75,1)   node[left] {$\bm f$};
      \end{scope}
    \end{tikzpicture}
  \end{center}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.1]
      \begin{scope}[rotate=-30]
	    \shade[ball color=gray!50](0,0) circle(1);
	    \draw[thick](-2,-1)--(2,-1);
	    ...
	    \draw[->,very thick](0,-1)--(-.5,-1) node[left]{$\bm f_s$};
...
\begin{frame}{Different Types of Connected Bodies}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.8]
      ...
      \end{scope}
      \draw[very thick,->](-1.5,.5)--(0,.5) node[pos=0,left]{$\bm F_a$};
    \end{tikzpicture}
  \end{center}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=.8]
      ...
      \end{scope}
      \draw[very thick,->](3,.5)--(4.5,.5) node[right]{$\bm F_a$};
    \end{tikzpicture}
  \end{center}
\end{frame}
