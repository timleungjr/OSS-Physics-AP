...
\begin{frame}{Kinetic Energy}
  When we apply a force on an object to accelerate it, and the resulting amount
  ...
  where $\displaystyle K=\frac{1}{2}mv^2$ is the (translational)
...
\begin{frame}{Work and Kinetic Energy}
  ...
  and we called that kinetic energy.
...
\begin{frame}{Example}
  ...
  object of mass \SI{2.}{kg} as it moves from $x=0$ to $x=\SI{5.}{\metre}$.
  Given that the object is at rest at $x=0$,
  \begin{enumerate}[(a)]
...
\begin{frame}
  ...
  \vspace{-.15in}For objects near the surface of Earth, we assume that
  ...
  \vspace{-.15in}where $U_g=mgh$ is the \textbf{gravitational potential energy}
\end{frame}
...
\begin{frame}
  ...
  \vspace{-.2in}When Hooke's law is applied to the work equation, we can find
  the work done to compress/stretch a spring:

  \vspace{-.35in}{\Large
    \begin{align*}
      W&=\int\mb{F}_e\cdot d\mb{x}=\int -kxdx=-\frac{1}{2}kx^2\Big|^{x_2}_{x_1}
      =-\Delta\left(\frac{1}{2}kx^2\right)\\
      &=-\Delta U_e
    \end{align*}
  }
  where $U_e=\frac{1}{2}kx^2$ is the elastic potential energy
\end{frame}



\begin{frame}{Work and Kinetic Energy}
  Like kinetic energy, the definition of gravitational and elastic potential
  energies came from integrating the work equation, in that work equals to the
  change in \emph{something}, and we called that potential energy.
...
\begin{frame}
  ...
  \eq{-.25in}{\boxed{W = \Delta U+\Delta K}}
  ...
  \eq{-.3in}{\boxed{U + K = U' + K'}}

  Let's take a closer look at isolated systems
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=0.8]
      ...
      \draw[ultra thick,fill=white](0.25,0.25) rectangle(4.75,3.75);
      \draw[thick,
...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=0.8]
      ...
      \draw[fill=blue!50] (0,4) circle(0.2) node[right]{$\;m$};
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=0.7]
      \fill[pattern=north east lines] (0,0) rectangle(5,4);
      \draw[ultra thick] (0,0) rectangle(5,4);
      \draw[ultra thick,fill=blue!10](0.25,0.25) rectangle(4.75,3.75);
      \draw[thick,
        decoration={aspect=0.3,segment length=2mm, amplitude=2.5mm, coil},
        decorate] (2.5,3.75)--(2.5,2.25) node[midway,right]{$\;\;k$};
      \draw[fill=black!40](2,2.25) rectangle(3,1.25) node[midway]{$m$};
...
\begin{frame}
  ...
  \eq{-.2in}{
    \mb{F}=\frac{d\mb{p}}{dt}\;\rightarrow\; \mb{F}dt=d\mb{p}
  }
