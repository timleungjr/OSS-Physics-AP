    ...
    \begin{tikzpicture}[scale=.7]
      ...
      \begin{scope}[rotate=38]
        \begin{scope}[very thick,->]
          \draw[red!70!black] (2.45,0)--(1,0) node[below]{$\vec F_c$};
...
%    \end{tikzpicture}
%  \end{center}
%  $\bm F_\text{net}=\bm 0$, therefore $\bm a_{CM}=\bm 0$. But it is also obvious
%  that the rod would \emph{rotate} instead.
%\end{frame}
...
\begin{frame}{What is Torque?}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=2.8]
      ...
      \fill (0,0) circle (.03);
      \begin{scope}[very thick]
        \draw[red!70!black,->](0,0)--(1.8,0) node[midway,below]{$\vec r$};
        \draw[blue!70!black,->](1.2,-.7)--(1.8,0) node[pos=0,below]{$\vec F$};
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=2.5]
      \begin{scope}[rotate=70]
        ...
        \fill (0,0) circle (.05);
        \begin{scope}[very thick,->]
          \draw[red!70!black](0,0)--(2,0)node[midway,right]{$\vec r$};
...
\begin{frame}{But there is no rotational motion, is there?}
  ...
  \begin{center}
    \begin{tikzpicture}
      \draw[dashed](-5,0)--(5,0);
      \draw[very thick,red!70!black,->](-5,0)--(-3,0) node[below]{$\vec v$};
      \shade[ball color=red!70!black] (-5,0) circle(.2) node[above left]{$m$};
...
%
%  \eq{-.2in}{
%    W_t=\int_{x_1}^{x_2}\vec F\cdot \dl\vecx= x
%  }
%
...
%  \eq{-.2in}{
%    \boxed{
%      W_r=\int_{\theta_1}^{\theta_2}\vec\tau\cdot \dl\vec\theta
%    }
%  }
%
