  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=.7]
      ...
      \begin{scope}[rotate=38]
        ...
        \draw[vectors] (2.5,0) arc(0:100:2.5) node[above left]{$\omega$};
...
\begin{frame}{What is Torque?}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=2.8]
      \draw[thick,fill=lightgray] (0,-.05) rectangle(2,.05);
      \draw[thick,fill=lightgray] circle(.15);
      \fill circle(.03);
      \draw[vectors,red] (0,0)--(1.8,0) node[midway,below]{$\vec r$};
      \draw[vectors,blue] (1.2,-.7)--(1.8,0) node[pos=0,below]{$\vec F$};
      \draw[vectors] (1.4,0) arc(180:230:.4) node[midway,left]{$\phi$};
    \end{tikzpicture}
  \end{center}
\end{frame}
