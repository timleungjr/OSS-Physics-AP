...
%  \question A meter stick is balanced on a fulcrum at its center, as shown. A mass
...
%    \choice\SI{6 }{\kilo\gram}
%    \choice\SI{4 }{\kilo\gram}
%    \choice\SI{3 }{\kilo\gram}
...
%    \end{choices}
  ...
  \question The average power developed by the friction in the axle of the disk
    ...
    \begin{choices}
    \choice \begin{tikzpicture}[scale=.6]
      \draw(0,0) circle(1);
      \fill(0,0) circle(.1);
      \begin{scope}[very thick,->]
