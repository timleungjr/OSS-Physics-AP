...
\begin{multicols*}{2}
  \begin{questions}
    ...
    \question A metal bar of constant density and weight $\vec w$ is attached
    to a pivot on the wall at point $P$ and supported by a rope that makes an
    angle of \ang{60} with the vertical wall. The reaction force exerted by the
    pivot on the bar at point $P$ is best represented by which arrow?
    \cpic{.25}{metal-bar}
    \begin{choices}
      \choice{\Huge$\nearrow$}
      \choice{\Huge$\uparrow$}
    ...
    \begin{center}
      \begin{tikzpicture}[scale=.6]
        ...
        \draw[thick] circle(3);
        \fill[thick] circle(.08);
        \draw[thick,<->] (0,0)--(0,-1.2) node[midway,right]{$r$};
        \draw[thick,<->,rotate=-55] (0,0)--(0,-3)
        node[pos=.6,above,rotate=35]{$3r$};
    ...
    \uplevel{
      \begin{center}
        \begin{tikzpicture}[scale=.85]
          ...
          \draw[vectors] (2,.1)--(2,1.5) node[above]{$\varv_0$};
        \end{tikzpicture}
