...
\begin{frame}{First Law of Thermodynamics}
  ...
  It's up to you to show that this equation is derived from the definition of
  mechanical work: $\displaystyle W=\int\mb{F}\cdot d\mb{s}$.
\end{frame}



\begin{frame}{Work Done To a Gas}
...
\begin{frame}{Quasi-Static Processes}
  ...
  concerned with $4$ of these process:
  \begin{itemize}
