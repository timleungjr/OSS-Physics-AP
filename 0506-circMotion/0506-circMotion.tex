...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{.7\textwidth}
    \begin{itemize}
    \item We can relate the actual speed $v$ to the $\omega$ simply by:
...
\begin{frame}
  ...
  \end{center}
  \begin{itemize}
  \item<2-> $F_1$ will rotate the beam counter clockwise
  \item<3-> $F_2$ will rotate the beam clockwise
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \vspace{-0.1in}{\Large
      \begin{displaymath}
        \boxed{L=rmv=mr^2\omega=I\omega}
      \end{displaymath}
    }
