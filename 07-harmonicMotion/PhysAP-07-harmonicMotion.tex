...
\begin{frame}{Vertical Spring-Mass System}
  \begin{columns}
    ...
    \column{.85\textwidth}
    For a vertical spring-mass system, we have to consider the weight of the
    mass as well:
...
\begin{frame}{Vertical Spring-Mass System}
  \begin{columns}
    ...
    Angular frequency remains the same as the horizontal case:
...
\begin{frame}{The Simple Pendulum}
  \begin{columns}
    ...
    shows that for small angles ($\theta_\mathrm{max}<\ang{15}$),
