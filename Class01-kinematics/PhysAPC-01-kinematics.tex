...
\begin{frame}{Instantaneous \& Average Velocity}
  ...
  position. It is related to position $\vec r(t)$ by:
  ...
  where $\vec r_0=\vec r(0)$, evaluated at $t=0$, is the constant of integration
  Likewise, the \textbf{average velocity} $\vec v_\text{avg}(t)$ is the change in
  position $\Delta\vec r(t)$ over a finite time interval $t$:

  \eq{-.1in}{
    \boxed{
      \vec v_\text{avg}(t) = \frac{\Delta\vec r(t)}t=
