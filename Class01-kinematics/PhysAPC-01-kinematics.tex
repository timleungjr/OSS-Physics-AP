...
\begin{frame}{Graphing ``Linear'' Functions: Example}
  ...
  \eq{-.1in}{
    \underbracket{\sin\theta_2}_y=\underbracket{\left[\frac{n_1}{n_2}\right]}_m
    \underbracket{\sin\theta_1}_x
  }
...
\begin{frame}{Graphing ``Linear'' Functions: Another Example}
  ...
  \eq{-.15in}{
    \underbracket{T^2}_y=\underbracket{\left[\frac{4\pi^2}g\right]}_m
    \underbracket{\ell}_x
  }
