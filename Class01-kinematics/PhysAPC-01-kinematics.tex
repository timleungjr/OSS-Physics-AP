...
\begin{frame}{Position}
  \textbf{Position} ($\vec r(t)$) describes the location of an object in a
...
\begin{frame}{Displacement}
  ...
  %\item Since the reference point $\vec{x}_\text{ref}=\vec{0}$, the position
  %  vector $\vec{x}$ is also its displacement from the reference point
  %\end{itemize}
\end{frame}
...
\begin{frame}{Instantaneous \& Average Velocity}
  ...
  \eq{-.1in}{
    \boxed{
      \vec v_\text{ave}(t) = \frac{\Delta\vec r}t=
      \frac{\vec r(t)-\vec r_0}{t} = \frac{\int_0^t\vec v\dl t}{t}
    }
  }
...
\begin{frame}{Instantaneous \& Average Speed}
  ...
  \eq{-.15in}{
    \boxed{
      v_\text{avg}(t)=\frac{s(t)}t=\frac{\int_0^t v\dl t}t
    }
  }
...
\begin{frame}{Relative Motion}
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=1.3]
      ...
      \draw[very thick,->,blue!30](0,0)--(3,1) node[midway,below]{$\vec r_{AC}$};
      \draw[very thick,->,orange!30](2,3)--(3,1)node[midway,right]{$\vec r_{AB}$};
    ...
    \eq{-.3in}{
      \boxed{
        \textcolor{blue}{\vec r_{AC}}=
        \textcolor{orange}{\vec r_{AB}}+
        \textcolor{violet}{\vec r_{BC}}
      }
    }
  \end{columns}
\end{frame}
...
\begin{frame}{Relative Motion}
  \begin{columns}
    ...
    \eq{-.33in}{
      \boxed{
        \textcolor{blue}{\vec r_{AC}} =
        \textcolor{orange}{\vec r_{AB}} + \textcolor{violet}{\vec r_{BC}}
      }
    }
    ...
    \eq{-.25in}{
      \boxed{
        \textcolor{blue}{\vec v_{AC}} =
        \textcolor{orange}{\vec v_{AB}}+ \textcolor{violet}{\vec v_{BC}}
      }
    }
    ...
    \eq{-.25in}{
      \boxed{
        \textcolor{blue}{\vec a_{AC}} =
        \textcolor{orange}{\vec a_{AB}} + \textcolor{violet}{\vec a_{BC}}
      }
    }
  \end{columns}
\end{frame}
