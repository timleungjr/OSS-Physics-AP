...
%For the Fall 2022 session, class times
%are on \textbf{Sundays from 1:20 to 3:50pm}. The course runs from October 2022
%to April 2023.
...
\item Be respectful for yourself and others. You may not be an adult yet, but
  you should still act like one%, and the facilities; act in a
